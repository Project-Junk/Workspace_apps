...
.field private n:Landroidx/appcompat/widget/ai;
...
.method a(I)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/ActivityChooserView;->getListPopupWindow()Landroidx/appcompat/widget/ai;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/appcompat/widget/ai;->d()Z
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ai;->h(I)V

    invoke-virtual {p1}, Landroidx/appcompat/widget/ai;->b_()V
    ...
    invoke-virtual {v0, v2}, Landroidx/core/f/b;->a(Z)V

    :cond_4
    invoke-virtual {p1}, Landroidx/appcompat/widget/ai;->e()Landroid/widget/ListView;
    ...
    sget v2, Landroidx/appcompat/a$h;->abc_activitychooserview_choose_application:I
...
.method public b()Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ai;->c()V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActivityChooserView;->m:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method public getDataModel()Landroidx/appcompat/widget/c;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/ActivityChooserView$a;->d()Landroidx/appcompat/widget/c;
...
.method getListPopupWindow()Landroidx/appcompat/widget/ai;
    .locals 2

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/ai;
    ...
    invoke-direct {v0, v1}, Landroidx/appcompat/widget/ai;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/ai;

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/ai;

    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->a:Landroidx/appcompat/widget/ActivityChooserView$a;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ai;->a(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/ai;

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/ai;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ai;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/ai;

    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->i:Landroidx/appcompat/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ai;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/ai;
