...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, v2, p3, v1}, Landroidx/appcompat/widget/av;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/av;

    move-result-object v2

    sget v4, Landroidx/appcompat/a$j;->SwitchCompat_android_thumb:I

    invoke-virtual {v2, v4}, Landroidx/appcompat/widget/av;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2, v4}, Landroidx/appcompat/widget/av;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2, v4, v3}, Landroidx/appcompat/widget/av;->a(IZ)Z
    ...
    invoke-virtual {v2, v4, v1}, Landroidx/appcompat/widget/av;->e(II)I
    ...
    invoke-virtual {v2, v4, v1}, Landroidx/appcompat/widget/av;->a(IZ)Z
    ...
    invoke-virtual {v2, v4}, Landroidx/appcompat/widget/av;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v2, v4, v5}, Landroidx/appcompat/widget/av;->a(II)I

    move-result v4

    invoke-static {v4, v0}, Landroidx/appcompat/widget/ad;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v2, v0, v1}, Landroidx/appcompat/widget/av;->g(II)I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->M:Landroidx/appcompat/widget/x;

    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->M:Landroidx/appcompat/widget/x;

    invoke-virtual {v0, p2, p3}, Landroidx/appcompat/widget/x;->a(Landroid/util/AttributeSet;I)V

    invoke-virtual {v2}, Landroidx/appcompat/widget/av;->b()V
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v1}, Landroidx/appcompat/widget/ad;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v1, Landroidx/appcompat/widget/ad;->a:Landroid/graphics/Rect;
...
.method public a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/av;->e(II)I
    ...
    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/av;->a(II)I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Landroidx/appcompat/widget/ad;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Landroidx/appcompat/widget/ad;->a:Landroid/graphics/Rect;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Landroidx/appcompat/widget/ad;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/ad;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
