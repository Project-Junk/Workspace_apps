...
# interfaces
.implements Landroidx/appcompat/widget/al$e;
...
.method private a(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/aq;->a(Landroid/content/Context;I)I
...
.method private a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/ad;->c(Landroid/graphics/drawable/Drawable;)Z
...
.method private b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget v1, Landroidx/appcompat/a$a;->colorControlHighlight:I

    invoke-static {p1, v1}, Landroidx/appcompat/widget/aq;->a(Landroid/content/Context;I)I

    move-result v1

    sget v2, Landroidx/appcompat/a$a;->colorButtonNormal:I

    invoke-static {p1, v2}, Landroidx/appcompat/widget/aq;->c(Landroid/content/Context;I)I

    move-result p1

    sget-object v2, Landroidx/appcompat/widget/aq;->a:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/aq;->d:[I

    const/4 v2, 0x1

    aput-object p1, v0, v2

    invoke-static {v1, p2}, Landroidx/core/graphics/a;->a(II)I

    move-result p1

    aput p1, p0, v2

    sget-object p1, Landroidx/appcompat/widget/aq;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/aq;->h:[I
...
.method private d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget v1, Landroidx/appcompat/a$a;->colorSwitchThumbNormal:I

    invoke-static {p1, v1}, Landroidx/appcompat/widget/aq;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v5, Landroidx/appcompat/widget/aq;->a:[I
    ...
    sget-object v4, Landroidx/appcompat/widget/aq;->e:[I

    aput-object v4, v0, v3

    sget v4, Landroidx/appcompat/a$a;->colorControlActivated:I

    invoke-static {p1, v4}, Landroidx/appcompat/widget/aq;->a(Landroid/content/Context;I)I
    ...
    :cond_0
    sget-object v1, Landroidx/appcompat/widget/aq;->a:[I

    aput-object v1, v0, v4

    sget v1, Landroidx/appcompat/a$a;->colorSwitchThumbNormal:I

    invoke-static {p1, v1}, Landroidx/appcompat/widget/aq;->c(Landroid/content/Context;I)I

    move-result v1

    aput v1, p0, v4

    sget-object v1, Landroidx/appcompat/widget/aq;->e:[I

    aput-object v1, v0, v3

    sget v1, Landroidx/appcompat/a$a;->colorControlActivated:I
    ...
    sget-object v1, Landroidx/appcompat/widget/aq;->h:[I
...
.method public a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget p0, Landroidx/appcompat/a$c;->abc_tint_edittext:I
    ...
    sget p0, Landroidx/appcompat/a$c;->abc_tint_switch_track:I
    ...
    sget p0, Landroidx/appcompat/a$a;->colorControlNormal:I

    invoke-static {p1, p0}, Landroidx/appcompat/widget/aq;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget p0, Landroidx/appcompat/a$c;->abc_tint_default:I
    ...
    sget p0, Landroidx/appcompat/a$c;->abc_tint_btn_checkable:I
    ...
    :cond_9
    sget p0, Landroidx/appcompat/a$e;->abc_seekbar_thumb_material:I

    if-ne p2, p0, :cond_a

    sget p0, Landroidx/appcompat/a$c;->abc_tint_seek_thumb:I
    ...
    :cond_b
    :goto_0
    sget p0, Landroidx/appcompat/a$c;->abc_tint_spinner:I
...
.method public a(I)Landroid/graphics/PorterDuff$Mode;
    ...
    sget p0, Landroidx/appcompat/a$e;->abc_switch_thumb_material:I
...
.method public a(Landroidx/appcompat/widget/al;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 2

    sget p0, Landroidx/appcompat/a$e;->abc_cab_background_top_material:I
    ...
    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/al;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/aq;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/aq;->c(Landroid/content/Context;I)I
...
.method public b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    :cond_2
    sget p0, Landroidx/appcompat/a$e;->abc_list_divider_mtrl_alpha:I
    ...
    :cond_3
    sget p0, Landroidx/appcompat/a$e;->abc_dialog_material_background:I
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/ad;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p1, v2}, Landroidx/appcompat/widget/aq;->a(Landroid/content/Context;I)I

    move-result p0

    invoke-static {p0, v0}, Landroidx/appcompat/widget/i;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
