...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/q;->b:Landroid/widget/ProgressBar;
...
.method private a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v4, v5}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, p2}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    invoke-interface {v0, p0}, Landroidx/core/graphics/drawable/c;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v5, v4}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/q;->c:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Landroidx/appcompat/widget/q;->c:Landroid/graphics/Bitmap;

    :cond_6
    new-instance v2, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {p0}, Landroidx/appcompat/widget/q;->b()Landroid/graphics/drawable/shapes/Shape;
...
.method a()Landroid/graphics/Bitmap;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/q;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/q;->b:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p1, v2}, Landroidx/appcompat/widget/av;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2, v2}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
