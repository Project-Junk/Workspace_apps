...
.method constructor <init>(Landroidx/recyclerview/widget/f$a;Ljava/util/List;[I[IZ)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/f$a;->a()I

    move-result p2

    iput p2, p0, Landroidx/recyclerview/widget/f$b;->e:I

    invoke-virtual {p1}, Landroidx/recyclerview/widget/f$a;->b()I
...
.method private a()V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/f$b;->a:Ljava/util/List;
...
.method private a(Ljava/util/List;Landroidx/recyclerview/widget/j;III)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, p3, p4}, Landroidx/recyclerview/widget/j;->a(II)V
    ...
    invoke-interface {p2, v5, p3}, Landroidx/recyclerview/widget/j;->c(II)V

    if-ne v1, v3, :cond_4

    iget-object v1, p0, Landroidx/recyclerview/widget/f$b;->d:Landroidx/recyclerview/widget/f$a;

    invoke-virtual {v1, v4, v2}, Landroidx/recyclerview/widget/f$a;->c(II)Ljava/lang/Object;

    move-result-object v1

    invoke-interface {p2, p3, v0, v1}, Landroidx/recyclerview/widget/j;->a(IILjava/lang/Object;)V

    goto :goto_2

    :cond_3
    invoke-interface {p2, p3, v0}, Landroidx/recyclerview/widget/j;->a(II)V
...
.method private a(IIIZ)Z
    ...
    invoke-virtual {p2, v0, v1}, Landroidx/recyclerview/widget/f$a;->a(II)Z
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/recyclerview/widget/f$a;->b(II)Z
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/f$b;->b:[I
    ...
    invoke-virtual {v0, v1, p2}, Landroidx/recyclerview/widget/f$a;->a(II)Z
    ...
    invoke-virtual {p3, v1, p2}, Landroidx/recyclerview/widget/f$a;->b(II)Z
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/f$b;->c:[I
...
.method private b()V
    ...
    invoke-virtual {v6, v1, v5}, Landroidx/recyclerview/widget/f$a;->b(II)Z
...
.method private b(Ljava/util/List;Landroidx/recyclerview/widget/j;III)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, p3, p4}, Landroidx/recyclerview/widget/j;->b(II)V
    ...
    invoke-interface {p2, v6, v7}, Landroidx/recyclerview/widget/j;->c(II)V
    ...
    invoke-virtual {v3, v2, v4}, Landroidx/recyclerview/widget/f$a;->c(II)Ljava/lang/Object;

    move-result-object v2

    invoke-interface {p2, v1, v0, v2}, Landroidx/recyclerview/widget/j;->a(IILjava/lang/Object;)V
    ...
    invoke-interface {p2, v1, v0}, Landroidx/recyclerview/widget/j;->b(II)V
...
.method public a(Landroidx/recyclerview/widget/RecyclerView$a;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/f$b;->a(Landroidx/recyclerview/widget/j;)V
...
.method public a(Landroidx/recyclerview/widget/j;)V
    ...
    invoke-direct {v0, p1}, Landroidx/recyclerview/widget/c;-><init>(Landroidx/recyclerview/widget/j;)V
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/recyclerview/widget/f$b;->b(Ljava/util/List;Landroidx/recyclerview/widget/j;III)V
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/recyclerview/widget/f$b;->a(Ljava/util/List;Landroidx/recyclerview/widget/j;III)V
    ...
    invoke-virtual {v2, v3, v4}, Landroidx/recyclerview/widget/f$a;->c(II)Ljava/lang/Object;
