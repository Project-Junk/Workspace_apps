...
.method private b(Lcolor/support/v7/app/a;)V
    ...
    iget-object v1, p0, Lcolor/support/v7/app/a$a;->M:Landroid/database/Cursor;
    ...
    iget-object v7, p0, Lcolor/support/v7/app/a$a;->N:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, p0, Lcolor/support/v7/app/a$a;->y:Landroid/widget/ListAdapter;
    ...
    :cond_3
    new-instance v1, Lcolor/support/v7/app/a$c;

    iget-object v3, p0, Lcolor/support/v7/app/a$a;->a:Landroid/content/Context;

    iget-object v5, p0, Lcolor/support/v7/app/a$a;->v:[Ljava/lang/CharSequence;

    invoke-direct {v1, v3, v4, v2, v5}, Lcolor/support/v7/app/a$c;-><init>(Landroid/content/Context;II[Ljava/lang/CharSequence;)V
    ...
    sget p0, Lcolor/support/v7/a/a$f;->color_alert_dialog_item_background:I

    invoke-virtual {v0, p0}, Lcolor/support/v7/app/a$d;->setSelector(I)V
    ...
    :cond_a
    iget-boolean p0, p0, Lcolor/support/v7/app/a$a;->I:Z
    ...
    invoke-virtual {v0, p0}, Lcolor/support/v7/app/a$d;->setChoiceMode(I)V
...
.method public a(Lcolor/support/v7/app/a;)V
    ...
    :cond_d
    iget-object v0, p0, Lcolor/support/v7/app/a$a;->B:Landroid/view/View;
    ...
    invoke-virtual {p1, v0}, Lcolor/support/v7/app/a;->c(Landroid/view/View;)V
    ...
    :cond_10
    :goto_1
    iget p0, p0, Lcolor/support/v7/app/a$a;->S:I

    invoke-virtual {p1, p0}, Lcolor/support/v7/app/a;->d(I)V
