.class public Lcom/color/support/util/h;
.super Ljava/lang/Object;


# static fields
.field private static a:Lcom/color/support/util/h;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/color/support/util/h;->b:Landroid/graphics/Path;

    return-void
.end method

.method public static declared-synchronized a()Lcom/color/support/util/h;
    .locals 2

    const-class v0, Lcom/color/support/util/h;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/color/support/util/h;->a:Lcom/color/support/util/h;

    if-nez v1, :cond_0

    new-instance v1, Lcom/color/support/util/h;

    invoke-direct {v1}, Lcom/color/support/util/h;-><init>()V

    sput-object v1, Lcom/color/support/util/h;->a:Lcom/color/support/util/h;
...
.method public a(FFFFF)Landroid/graphics/Path;
    ...
    invoke-virtual/range {v0 .. v9}, Lcom/color/support/util/h;->a(FFFFFZZZZ)Landroid/graphics/Path;
...
.method public a(FFFFFZZZZ)Landroid/graphics/Path;
    ...
    iget-object v1, v0, Lcom/color/support/util/h;->b:Landroid/graphics/Path;
    ...
    iget-object v0, v0, Lcom/color/support/util/h;->b:Landroid/graphics/Path;
...
.method public a(Landroid/graphics/RectF;F)Landroid/graphics/Path;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/color/support/util/h;->a(FFFFF)Landroid/graphics/Path;
