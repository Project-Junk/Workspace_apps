.class public Lcom/coloros/backup/sdk/utils/SDCardUtils;
...
.method private static delAllFile(Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->delAllFile(Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->delFolder(Ljava/lang/String;)V
...
.method public static delFolder(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {p0}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->delAllFile(Ljava/lang/String;)Z
...
.method private static filterFile([Ljava/io/File;)Ljava/util/ArrayList;
    .locals 5
...
.method public static getAppsBackupPath(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->getStoragePath(Landroid/content/Context;)Ljava/lang/String;
...
.method public static getExternalBackupPath(Landroid/content/Context;)Ljava/lang/String;
    .locals 1

    invoke-static {}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->getExternalSdDirectory()Ljava/io/File;
...
.method public static getExternalBackupPathXiaoXie(Landroid/content/Context;)Ljava/lang/String;
    .locals 1
...
.method public static getExternalSdDirectory()Ljava/io/File;
    ...
    sget-object v0, Lcom/coloros/backup/sdk/utils/SDCardUtils;->sStorageManager:Landroid/os/storage/StorageManager;
...
.method public static getFileSize(Ljava/io/File;)J
    ...
    invoke-static {v3}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->getFileSize(Ljava/io/File;)J
...
.method public static getInternalBackupPath()Ljava/lang/String;
    .locals 2
...
.method public static getInternalBackupPathXiaoXie()Ljava/lang/String;
    .locals 2
...
.method public static getStoragePath(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->hasSdcard(Landroid/content/Context;)Z
    ...
    :cond_1
    invoke-static {p0}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->getStorageSetting(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->getAvailableSize(Ljava/lang/String;)J
    ...
    const-string v3, "getStoragePath: path is "
...
.method private static hasConfigDatabaseFile(Ljava/io/File;)Z
    .locals 5
...
.method public static initStorageManager(Landroid/content/Context;)V
    ...
    sput-object p0, Lcom/coloros/backup/sdk/utils/SDCardUtils;->sStorageManager:Landroid/os/storage/StorageManager;
...
.method private static scanAllBackupFolders(Landroid/content/Context;)Ljava/util/ArrayList;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->getPersonalDataBackupPath(Landroid/content/Context;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->scanBackupFiles(Ljava/lang/String;)Ljava/util/ArrayList;
...
.method private static scanBackupFiles(Ljava/lang/String;)Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lcom/coloros/backup/sdk/utils/SDCardUtils;->filterFile([Ljava/io/File;)Ljava/util/ArrayList;
