...
.method constructor <init>(Landroid/content/Context;Ljava/util/List;J)V
    ...
    .line 36
    invoke-direct {p0}, Landroidx/preference/b;->b()V
...
.method private a(Ljava/util/List;)V
    ...
    .line 62
    invoke-virtual {v2}, Landroidx/preference/Preference;->x()Ljava/lang/CharSequence;
    ...
    .line 76
    :cond_3
    invoke-virtual {p0}, Landroidx/preference/b;->J()Landroid/content/Context;
    ...
    .line 81
    :cond_4
    invoke-virtual {p0, v1}, Landroidx/preference/b;->a(Ljava/lang/CharSequence;)V
...
.method private b()V
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/b;->a(I)V

    .line 46
    sget v0, Landroidx/preference/R$drawable;->ic_arrow_down_24dp:I

    invoke-virtual {p0, v0}, Landroidx/preference/b;->d(I)V

    .line 47
    sget v0, Landroidx/preference/R$string;->expand_button_title:I

    invoke-virtual {p0, v0}, Landroidx/preference/b;->c(I)V

    const/16 v0, 0x3e7

    .line 49
    invoke-virtual {p0, v0}, Landroidx/preference/b;->b(I)V
