...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/j;->a:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/j;->b:Landroid/view/animation/DecelerateInterpolator;
    ...
    iput-object p1, p0, Landroidx/recyclerview/widget/j;->f:Landroid/util/DisplayMetrics;
...
.method private k()F
    ...
    .line 171
    iget-object v0, p0, Landroidx/recyclerview/widget/j;->f:Landroid/util/DisplayMetrics;

    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/j;->a(Landroid/util/DisplayMetrics;)F
...
.method public a(Landroid/view/View;I)I
    ...
    .line 314
    invoke-virtual {p0}, Landroidx/recyclerview/widget/j;->e()Landroidx/recyclerview/widget/RecyclerView$i;
    ...
    .line 324
    invoke-virtual/range {v4 .. v9}, Landroidx/recyclerview/widget/j;->a(IIIII)I
...
.method protected a(IILandroidx/recyclerview/widget/RecyclerView$t;Landroidx/recyclerview/widget/RecyclerView$s$a;)V
    .locals 0

    .line 127
    invoke-virtual {p0}, Landroidx/recyclerview/widget/j;->j()I
    ...
    .line 137
    :cond_0
    iget p3, p0, Landroidx/recyclerview/widget/j;->d:I

    invoke-direct {p0, p3, p1}, Landroidx/recyclerview/widget/j;->b(II)I
    ...
    invoke-direct {p0, p1, p2}, Landroidx/recyclerview/widget/j;->b(II)I
    ...
    .line 141
    invoke-virtual {p0, p4}, Landroidx/recyclerview/widget/j;->a(Landroidx/recyclerview/widget/RecyclerView$s$a;)V

    :cond_1
    return-void
.end method

.method protected a(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$t;Landroidx/recyclerview/widget/RecyclerView$s$a;)V
    .locals 2

    .line 110
    invoke-virtual {p0}, Landroidx/recyclerview/widget/j;->c()I

    move-result p2

    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/j;->b(Landroid/view/View;I)I

    move-result p2

    .line 111
    invoke-virtual {p0}, Landroidx/recyclerview/widget/j;->d()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Landroidx/recyclerview/widget/j;->a(Landroid/view/View;I)I
    ...
    .line 113
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/j;->a(I)I
    ...
    .line 115
    iget-object v1, p0, Landroidx/recyclerview/widget/j;->b:Landroid/view/animation/DecelerateInterpolator;
...
.method protected a(Landroidx/recyclerview/widget/RecyclerView$s$a;)V
    .locals 4
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/j;->d(I)Landroid/graphics/PointF;
    ...
    .line 251
    :cond_0
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/j;->a(Landroid/graphics/PointF;)V

    .line 252
    iput-object v0, p0, Landroidx/recyclerview/widget/j;->c:Landroid/graphics/PointF;
    ...
    iput v1, p0, Landroidx/recyclerview/widget/j;->d:I
    ...
    .line 256
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/j;->b(I)I
    ...
    iget v3, p0, Landroidx/recyclerview/widget/j;->e:I
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/j;->a:Landroid/view/animation/LinearInterpolator;
    ...
    .line 247
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView$s$a;->a(I)V
...
.method protected b(I)I
    ...
    invoke-direct {p0}, Landroidx/recyclerview/widget/j;->k()F
...
.method protected c()I
    ...
    .line 218
    iget-object v0, p0, Landroidx/recyclerview/widget/j;->c:Landroid/graphics/PointF;
