...
# instance fields
.field final a:Landroidx/recyclerview/widget/s$b;

.field b:Landroidx/recyclerview/widget/s$a;


# direct methods
.method constructor <init>(Landroidx/recyclerview/widget/s$b;)V
    .locals 0
...
.method a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroidx/recyclerview/widget/s$b;->a()I
    ...
    invoke-interface {v6, v4}, Landroidx/recyclerview/widget/s$b;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v7, v0, v1, v5, v6}, Landroidx/recyclerview/widget/s$a;->a(IIII)V
    ...
    invoke-virtual {v5}, Landroidx/recyclerview/widget/s$a;->a()V
...
.method a(Landroid/view/View;I)Z
    ...
    invoke-interface {v1}, Landroidx/recyclerview/widget/s$b;->a()I

    move-result v1

    iget-object v2, p0, Landroidx/recyclerview/widget/s;->a:Landroidx/recyclerview/widget/s$b;

    invoke-interface {v2}, Landroidx/recyclerview/widget/s$b;->b()I
    ...
    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/s$b;->b(Landroid/view/View;)I

    move-result p1

    .line 248
    invoke-virtual {v0, v1, v2, v3, p1}, Landroidx/recyclerview/widget/s$a;->a(IIII)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/s$a;->a()V
