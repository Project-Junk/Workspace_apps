.class public final Lco/polarr/renderer/filters/ao;
...
.field private static g:Landroid/util/LruCache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Ljava/lang/String;",
            "Lco/polarr/renderer/filters/ao;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lco/polarr/renderer/filters/ao;->g:Landroid/util/LruCache;
...
.method private constructor <init>(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)V
    ...
    iput-object p1, p0, Lco/polarr/renderer/filters/ao;->H:Ljava/lang/String;

    return-void
.end method

.method public static a(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)Lco/polarr/renderer/filters/ao;
    .locals 2

    sget-object v0, Lco/polarr/renderer/filters/ao;->g:Landroid/util/LruCache;
    ...
    check-cast v0, Lco/polarr/renderer/filters/ao;

    if-nez v0, :cond_0

    new-instance v0, Lco/polarr/renderer/filters/ao;

    invoke-direct {v0, p0, p1}, Lco/polarr/renderer/filters/ao;-><init>(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)V

    invoke-virtual {v0}, Lco/polarr/renderer/filters/ao;->k()V

    sget-object p0, Lco/polarr/renderer/filters/ao;->g:Landroid/util/LruCache;
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lco/polarr/renderer/filters/ao;->a(Lco/polarr/renderer/entities/Context;)V
...
.method protected d()V
    ...
    iget v0, p0, Lco/polarr/renderer/filters/ao;->x:I
    ...
    iget-object v1, p0, Lco/polarr/renderer/filters/ao;->u:Lco/polarr/renderer/entities/Context;
    ...
    iget-object v2, p0, Lco/polarr/renderer/filters/ao;->u:Lco/polarr/renderer/entities/Context;
    ...
    iget v1, p0, Lco/polarr/renderer/filters/ao;->a:F
    ...
    iget v1, p0, Lco/polarr/renderer/filters/ao;->b:F
    ...
    iget v1, p0, Lco/polarr/renderer/filters/ao;->c:F
    ...
    iget v1, p0, Lco/polarr/renderer/filters/ao;->d:F
    ...
    iget v1, p0, Lco/polarr/renderer/filters/ao;->e:F
    ...
    iget v1, p0, Lco/polarr/renderer/filters/ao;->f:F
