.class public Lco/polarr/renderer/filters/aw;
...
.field private static a:Landroid/util/LruCache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Ljava/lang/String;",
            "Lco/polarr/renderer/filters/aw;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lco/polarr/renderer/filters/aw;->a:Landroid/util/LruCache;
...
.method private constructor <init>(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)V
    ...
    iput-object p1, p0, Lco/polarr/renderer/filters/aw;->H:Ljava/lang/String;

    return-void
.end method

.method public static a(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)Lco/polarr/renderer/filters/aw;
    .locals 2

    sget-object v0, Lco/polarr/renderer/filters/aw;->a:Landroid/util/LruCache;
    ...
    check-cast v0, Lco/polarr/renderer/filters/aw;

    if-nez v0, :cond_0

    new-instance v0, Lco/polarr/renderer/filters/aw;

    invoke-direct {v0, p0, p1}, Lco/polarr/renderer/filters/aw;-><init>(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)V

    invoke-virtual {v0}, Lco/polarr/renderer/filters/aw;->k()V

    sget-object p0, Lco/polarr/renderer/filters/aw;->a:Landroid/util/LruCache;
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lco/polarr/renderer/filters/aw;->a(Lco/polarr/renderer/entities/Context;)V
...
.method protected d()V
    ...
    iget-object v3, p0, Lco/polarr/renderer/filters/aw;->u:Lco/polarr/renderer/entities/Context;
    ...
    :cond_0
    iget v1, p0, Lco/polarr/renderer/filters/aw;->x:I
    ...
    iget-object v4, p0, Lco/polarr/renderer/filters/aw;->u:Lco/polarr/renderer/entities/Context;
    ...
    iget-object v2, p0, Lco/polarr/renderer/filters/aw;->u:Lco/polarr/renderer/entities/Context;
    ...
    iget v0, p0, Lco/polarr/renderer/filters/aw;->x:I
    ...
    iget-object v1, p0, Lco/polarr/renderer/filters/aw;->u:Lco/polarr/renderer/entities/Context;
