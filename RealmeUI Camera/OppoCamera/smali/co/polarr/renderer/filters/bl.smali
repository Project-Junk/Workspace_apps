.class public Lco/polarr/renderer/filters/bl;
.super Lco/polarr/renderer/filters/bj;
...
.field private static h:Landroid/util/LruCache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Ljava/lang/String;",
            "Lco/polarr/renderer/filters/bl;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lco/polarr/renderer/filters/bl;->h:Landroid/util/LruCache;
...
.method public constructor <init>(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lco/polarr/renderer/filters/bj;-><init>(Landroid/content/res/Resources;Ljava/lang/String;Lco/polarr/renderer/entities/Context;)V
    ...
    iput-object p1, p0, Lco/polarr/renderer/filters/bl;->H:Ljava/lang/String;

    return-void
.end method

.method public static b(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)Lco/polarr/renderer/filters/bl;
    .locals 2

    sget-object v0, Lco/polarr/renderer/filters/bl;->h:Landroid/util/LruCache;
    ...
    check-cast v0, Lco/polarr/renderer/filters/bl;

    if-nez v0, :cond_0

    new-instance v0, Lco/polarr/renderer/filters/bl;

    invoke-direct {v0, p0, p1}, Lco/polarr/renderer/filters/bl;-><init>(Landroid/content/res/Resources;Lco/polarr/renderer/entities/Context;)V

    invoke-virtual {v0}, Lco/polarr/renderer/filters/bl;->k()V

    sget-object p0, Lco/polarr/renderer/filters/bl;->h:Landroid/util/LruCache;
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lco/polarr/renderer/filters/bl;->a(Lco/polarr/renderer/entities/Context;)V
...
.method protected d()V
    ...
    invoke-super {p0}, Lco/polarr/renderer/filters/bj;->d()V

    iget v0, p0, Lco/polarr/renderer/filters/bl;->x:I
    ...
    iget-object v1, p0, Lco/polarr/renderer/filters/bl;->u:Lco/polarr/renderer/entities/Context;
    ...
    iget-object v3, p0, Lco/polarr/renderer/filters/bl;->u:Lco/polarr/renderer/entities/Context;
    ...
    iget-object v5, p0, Lco/polarr/renderer/filters/bl;->u:Lco/polarr/renderer/entities/Context;
    ...
    iget-object v2, p0, Lco/polarr/renderer/filters/bl;->u:Lco/polarr/renderer/entities/Context;
    ...
    invoke-virtual {p0}, Lco/polarr/renderer/filters/bl;->i()V
