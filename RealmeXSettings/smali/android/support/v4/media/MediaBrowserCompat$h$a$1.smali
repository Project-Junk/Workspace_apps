...
.method public final run()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$a$1;->a:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$a$1;->b:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$h$a$1;->b:Landroid/os/IBinder;

    iget-object v5, p0, Landroid/support/v4/media/MediaBrowserCompat$h$a$1;->c:Landroid/support/v4/media/MediaBrowserCompat$h$a;

    iget-object v5, v5, Landroid/support/v4/media/MediaBrowserCompat$h$a;->a:Landroid/support/v4/media/MediaBrowserCompat$h;

    iget-object v5, v5, Landroid/support/v4/media/MediaBrowserCompat$h;->d:Landroid/os/Bundle;

    invoke-direct {v3, v4, v5}, Landroid/support/v4/media/MediaBrowserCompat$j;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v3, v1, Landroid/support/v4/media/MediaBrowserCompat$h;->h:Landroid/support/v4/media/MediaBrowserCompat$j;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$h$a$1;->c:Landroid/support/v4/media/MediaBrowserCompat$h$a;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$h$a;->a:Landroid/support/v4/media/MediaBrowserCompat$h;
    ...
    iput-object v3, v1, Landroid/support/v4/media/MediaBrowserCompat$h;->i:Landroid/os/Messenger;
    ...
    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$h;->i:Landroid/os/Messenger;
    ...
    iput v3, v1, Landroid/support/v4/media/MediaBrowserCompat$h;->f:I
    ...
    iget-object v1, v1, Landroid/support/v4/media/MediaBrowserCompat$h;->h:Landroid/support/v4/media/MediaBrowserCompat$j;

    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$a$1;->c:Landroid/support/v4/media/MediaBrowserCompat$h$a;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$h$a;->a:Landroid/support/v4/media/MediaBrowserCompat$h;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$h;->a:Landroid/content/Context;

    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$h$a$1;->c:Landroid/support/v4/media/MediaBrowserCompat$h$a;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$h$a;->a:Landroid/support/v4/media/MediaBrowserCompat$h;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$h;->i:Landroid/os/Messenger;
    ...
    .line 3158
    iget-object v6, v1, Landroid/support/v4/media/MediaBrowserCompat$j;->a:Landroid/os/Bundle;
