...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lcom/android/settings/datetime/timezone/BaseTimeZonePicker$a;Ljava/util/Locale;Ljava/lang/CharSequence;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 80
    invoke-static {p1, p2, p4}, Lcom/android/settings/datetime/timezone/BaseTimeZoneInfoPicker$ZoneAdapter;->a(Landroid/content/Context;Ljava/util/List;Ljava/util/Locale;)Ljava/util/List;
...
.method private static a(Landroid/content/Context;Ljava/util/List;Ljava/util/Locale;)Ljava/util/List;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v3, Lcom/android/settings/datetime/timezone/c;

    .line 93
    new-instance v8, Lcom/android/settings/datetime/timezone/BaseTimeZoneInfoPicker$a;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/settings/datetime/timezone/BaseTimeZoneInfoPicker$a;-><init>(JLcom/android/settings/datetime/timezone/c;Landroid/content/res/Resources;Landroid/icu/text/DateFormat;B)V
