...
# static fields
.field private static final a:Ljava/lang/String; = "StorageVolumePreference"


# instance fields
.field private final b:Landroid/os/storage/StorageManager;

.field private final c:Landroid/os/storage/VolumeInfo;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/storage/VolumeInfo;J)V
    ...
    .line 53
    iput v0, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->d:I
    ...
    iput-object v4, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->f:Landroid/view/View$OnClickListener;
    ...
    iput-object v4, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->b:Landroid/os/storage/StorageManager;

    .line 61
    iput-object v3, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->c:Landroid/os/storage/VolumeInfo;

    const v4, 0x1010429

    .line 62
    invoke-static {v2, v4}, Lcom/android/settingslib/l;->j(Landroid/content/Context;I)Landroid/content/res/ColorStateList;

    move-result-object v4

    iput-object v4, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->e:Landroid/content/res/ColorStateList;
    ...
    .line 67
    iget-object v4, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->b:Landroid/os/storage/StorageManager;
    ...
    .line 90
    :goto_1
    sget-object v11, Lcom/android/settings/deviceinfo/StorageVolumePreference;->a:Ljava/lang/String;
    ...
    .line 109
    :cond_3
    iget-object v0, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->b:Landroid/os/storage/StorageManager;
    ...
    .line 110
    invoke-static {v2, v0}, Lcom/android/settingslib/l;->j(Landroid/content/Context;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->e:Landroid/content/res/ColorStateList;
    ...
    .line 113
    iget-object v2, v1, Lcom/android/settings/deviceinfo/StorageVolumePreference;->e:Landroid/content/res/ColorStateList;
...
.method static synthetic a(Lcom/android/settings/deviceinfo/StorageVolumePreference;)Landroid/os/storage/VolumeInfo;
    ...
    .line 47
    iget-object p0, p0, Lcom/android/settings/deviceinfo/StorageVolumePreference;->c:Landroid/os/storage/VolumeInfo;
...
.method public onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    .line 133
    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageVolumePreference;->f:Landroid/view/View$OnClickListener;
    ...
    .line 137
    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageVolumePreference;->c:Landroid/os/storage/VolumeInfo;
    ...
    iget v1, p0, Lcom/android/settings/deviceinfo/StorageVolumePreference;->d:I
    ...
    .line 140
    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageVolumePreference;->e:Landroid/content/res/ColorStateList;
