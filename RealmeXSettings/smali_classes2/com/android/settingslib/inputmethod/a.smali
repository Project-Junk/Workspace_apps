.class public final Lcom/android/settingslib/inputmethod/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settingslib/inputmethod/a;->a:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    sput-object v0, Lcom/android/settingslib/inputmethod/a;->b:Landroid/text/TextUtils$SimpleStringSplitter;

    return-void
.end method

.method public static a(Landroid/view/inputmethod/InputMethodSubtype;Landroid/content/Context;Landroid/view/inputmethod/InputMethodInfo;)Ljava/lang/String;
    .locals 2
    ...
    .line 377
    :cond_0
    invoke-static {p1}, Lcom/android/settingslib/inputmethod/a;->a(Landroid/content/Context;)Ljava/util/Locale;
...
.method public static a(Ljava/util/List;Landroid/content/Context;Landroid/view/inputmethod/InputMethodInfo;)Ljava/lang/String;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static a(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1126
    sget-object v1, Lcom/android/settingslib/inputmethod/a;->a:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    :cond_0
    :goto_0
    sget-object p0, Lcom/android/settingslib/inputmethod/a;->a:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    .line 1129
    sget-object v1, Lcom/android/settingslib/inputmethod/a;->b:Landroid/text/TextUtils$SimpleStringSplitter;

    invoke-virtual {v1, p0}, Landroid/text/TextUtils$SimpleStringSplitter;->setString(Ljava/lang/String;)V

    .line 1130
    sget-object p0, Lcom/android/settingslib/inputmethod/a;->b:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    .line 1134
    :goto_1
    sget-object v2, Lcom/android/settingslib/inputmethod/a;->b:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method public static a(Landroidx/preference/PreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Z)V
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 162
    invoke-static/range {p1 .. p1}, Lcom/android/settingslib/inputmethod/a;->b(Landroid/content/ContentResolver;)I

    move-result v4

    .line 164
    invoke-static/range {p1 .. p1}, Lcom/android/settingslib/inputmethod/a;->a(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    .line 1150
    sget-object v9, Lcom/android/settingslib/inputmethod/a;->a:Landroid/text/TextUtils$SimpleStringSplitter;

    invoke-virtual {v9, v8}, Landroid/text/TextUtils$SimpleStringSplitter;->setString(Ljava/lang/String;)V

    .line 1151
    :goto_0
    sget-object v8, Lcom/android/settingslib/inputmethod/a;->a:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    .line 170
    invoke-virtual {v0, v13}, Landroidx/preference/PreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
    ...
    .line 255
    :cond_e
    invoke-static {v5}, Lcom/android/settingslib/inputmethod/a;->a(Ljava/util/HashMap;)Ljava/lang/String;

    move-result-object v0

    .line 257
    invoke-static {v6}, Lcom/android/settingslib/inputmethod/a;->a(Ljava/util/HashSet;)Ljava/lang/String;
