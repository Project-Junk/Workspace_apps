.class public Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;
.super Lcom/coloros/settings/feature/controller/BaseListDialogPreferenceController;
.source "ZenModeCallPreferenceController.java"
...
.field private static final TAG:Ljava/lang/String; = "ZenModeCallPreferenceController"
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 45
    invoke-virtual {p0, p1}, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->setSingleSelect(Z)V
...
.method public displayPreference(Landroidx/preference/PreferenceScreen;)V
    ...
    .line 58
    iget-object p1, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mContext:Landroid/content/Context;
    ...
    .line 59
    invoke-virtual {p0, p1}, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->setEntries([Ljava/lang/CharSequence;)V

    .line 61
    iget-object p1, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mDialogPreference:Landroidx/preference/DialogPreference;
    ...
    .line 63
    iget-object v0, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mDialogPreference:Landroidx/preference/DialogPreference;

    check-cast v0, Lcom/color/support/preference/ColorListPreference;

    iget v1, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mDefaultValueIndex:I
    ...
    iget v0, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mDefaultValueIndex:I
...
.method public handlePreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    iput-object p1, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mPolicy:Landroid/app/NotificationManager$Policy;
    ...
    .line 73
    iget-object v0, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mPolicy:Landroid/app/NotificationManager$Policy;
    ...
    const-string v3, "ZenModeCallPreferenceController"

    .line 75
    invoke-static {v3, v2}, Lcom/coloros/settings/utils/aa;->b(Ljava/lang/String;Ljava/lang/String;)V

    .line 77
    iget-object v2, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mBackend:Lcom/coloros/settings/feature/zenmode/b;
    ...
    iget-object v4, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mPolicy:Landroid/app/NotificationManager$Policy;

    iget v4, v4, Landroid/app/NotificationManager$Policy;->priorityMessageSenders:I

    iget-object v5, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mPolicy:Landroid/app/NotificationManager$Policy;

    iget v5, v5, Landroid/app/NotificationManager$Policy;->suppressedVisualEffects:I

    .line 78
    invoke-virtual {v2, v3, v0, v4, v5}, Lcom/coloros/settings/feature/zenmode/b;->a(IIII)V
    ...
    .line 85
    :goto_2
    iget-object v1, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mDialogPreference:Landroidx/preference/DialogPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mBackend:Lcom/coloros/settings/feature/zenmode/b;

    .line 52
    iget-object p1, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mPolicy:Landroid/app/NotificationManager$Policy;

    invoke-virtual {p1}, Landroid/app/NotificationManager$Policy;->allowCalls()Z
    ...
    :goto_0
    iput p1, p0, Lcom/coloros/settings/feature/zenmode/ZenModeCallPreferenceController;->mDefaultValueIndex:I
