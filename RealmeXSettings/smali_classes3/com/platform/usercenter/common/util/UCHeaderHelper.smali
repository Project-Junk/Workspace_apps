.class public Lcom/platform/usercenter/common/util/UCHeaderHelper;
...
.method public static createExtMobile(Landroid/content/Context;Z)Ljava/lang/String;
    ...
    .line 152
    invoke-static {}, Lcom/platform/usercenter/app/UCOSVersionUtil;->getCurRegion()Ljava/lang/String;
...
.method public static createExtSystem(Landroid/content/Context;Z)Ljava/lang/String;
    ...
    .line 95
    :cond_0
    invoke-static {}, Lcom/platform/usercenter/common/util/UCDeviceInfoUtil;->getAndroidVersion()Ljava/lang/String;
    ...
    .line 101
    :cond_2
    invoke-static {}, Lcom/platform/usercenter/common/util/UCDeviceInfoUtil;->getManufacture()Ljava/lang/String;
    ...
    .line 104
    :cond_3
    invoke-static {}, Lcom/platform/usercenter/app/UCOSVersionUtil;->getOsVersion()Ljava/lang/String;
    ...
    .line 107
    :cond_4
    invoke-static {p0}, Lcom/platform/usercenter/common/util/UCDeviceInfoUtil;->getOperators(Landroid/content/Context;)Ljava/lang/String;
...
.method public static createExtUser(Landroid/content/Context;Z)Ljava/lang/String;
    ...
    .line 122
    invoke-static {p0}, Lcom/platform/usercenter/tools/UCUtils;->md5Hex(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getHeaders(Landroid/content/Context;)Ljava/util/HashMap;
    ...
    .line 65
    invoke-static {p0, v0}, Lcom/platform/usercenter/common/util/UCHeaderHelper;->createExtSystem(Landroid/content/Context;Z)Ljava/lang/String;

    move-result-object v2

    .line 66
    invoke-static {p0, v0}, Lcom/platform/usercenter/common/util/UCHeaderHelper;->createExtUser(Landroid/content/Context;Z)Ljava/lang/String;

    move-result-object v3

    .line 67
    invoke-static {p0}, Lcom/platform/usercenter/common/util/UCHeaderHelper;->createExtApp(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    .line 68
    invoke-static {p0, v0}, Lcom/platform/usercenter/common/util/UCHeaderHelper;->createExtMobile(Landroid/content/Context;Z)Ljava/lang/String;
