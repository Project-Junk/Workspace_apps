...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 149
    iget-object p1, p0, Landroidx/mediarouter/app/MediaRouteButton;->mRemoteIndicatorLoader:Landroidx/mediarouter/app/MediaRouteButton$RemoteIndicatorLoader;

    sget-object p2, Landroid/os/AsyncTask;->THREAD_POOL_EXECUTOR:Ljava/util/concurrent/Executor;

    new-array p3, v1, [Ljava/lang/Void;

    invoke-virtual {p1, p2, p3}, Landroidx/mediarouter/app/MediaRouteButton$RemoteIndicatorLoader;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public jumpDrawablesToCurrentState()V
    ...
    .line 384
    invoke-virtual {p0}, Landroidx/mediarouter/app/MediaRouteButton;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method protected onCreateDrawableState(I)[I
    ...
    .line 318
    :cond_0
    iget-boolean p0, p0, Landroidx/mediarouter/app/MediaRouteButton;->mRemoteActive:Z
...
.method refreshRoute()V
    ...
    .line 491
    invoke-virtual {v0}, Landroidx/mediarouter/media/MediaRouter$RouteInfo;->isConnecting()Z
    ...
    .line 493
    :goto_1
    iget-boolean v4, p0, Landroidx/mediarouter/app/MediaRouteButton;->mRemoteActive:Z

    if-eq v4, v1, :cond_2

    .line 494
    iput-boolean v1, p0, Landroidx/mediarouter/app/MediaRouteButton;->mRemoteActive:Z

    move v2, v3

    .line 497
    :cond_2
    iget-boolean v4, p0, Landroidx/mediarouter/app/MediaRouteButton;->mIsConnecting:Z

    if-eq v4, v0, :cond_3

    .line 498
    iput-boolean v0, p0, Landroidx/mediarouter/app/MediaRouteButton;->mIsConnecting:Z
    ...
    invoke-virtual {p0, v4}, Landroidx/mediarouter/app/MediaRouteButton;->setEnabled(Z)V
    ...
    invoke-virtual {v4, p0}, Landroid/graphics/drawable/AnimationDrawable;->selectDrawable(I)Z
...
.method public setRemoteIndicatorDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 362
    iget-boolean v1, p0, Landroidx/mediarouter/app/MediaRouteButton;->mIsConnecting:Z
...
.method public showDialog()Z
    ...
    .line 264
    invoke-virtual {v1, v0, v2}, Landroidx/mediarouter/app/MediaRouteControllerDialogFragment;->show(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
    ...
    .line 255
    invoke-virtual {v1, v0, v2}, Landroidx/mediarouter/app/MediaRouteChooserDialogFragment;->show(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
