...
.method private getClient(Landroid/os/Messenger;)Landroidx/mediarouter/media/MediaRouteProviderService$ClientRecord;
    ...
    .line 478
    iget-object p0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->mClients:Ljava/util/ArrayList;

    invoke-virtual {p0, p1}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroidx/mediarouter/media/MediaRouteProviderService$ClientRecord;
...
.method onBinderDied(Landroid/os/Messenger;)V
    ...
    .line 229
    :cond_0
    invoke-virtual {p0}, Landroidx/mediarouter/media/MediaRouteProviderService$ClientRecord;->dispose()V
...
.method onCreateRouteController(Landroid/os/Messenger;IILjava/lang/String;Ljava/lang/String;)Z
    ...
    .line 237
    invoke-virtual {p0, p4, p5, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$ClientRecord;->createRouteController(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string p0, ": Route controller created, controllerId="

    invoke-virtual {v0, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p0, ", routeId="

    invoke-virtual {v0, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p0, ", routeGroupId="
...
.method onRegisterClient(Landroid/os/Messenger;II)Z
    ...
    .line 196
    iget p3, v1, Landroidx/mediarouter/media/MediaRouteProviderService$ClientRecord;->mVersion:I
...
.method onReleaseRouteController(Landroid/os/Messenger;II)Z
    ...
    .line 253
    invoke-virtual {p0, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$ClientRecord;->releaseRouteController(I)Z
    ...
    const-string p0, ": Route controller released"

    invoke-virtual {v0, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p0, ", controllerId="
...
.method onRouteControlRequest(Landroid/os/Messenger;IILandroid/content/Intent;)Z
    ...
    const-string p1, ": Route control request delivered"
...
.method onSelectRoute(Landroid/os/Messenger;II)Z
    ...
    .line 270
    invoke-virtual {p0, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$ClientRecord;->getRouteController(I)Landroidx/mediarouter/media/MediaRouteProvider$RouteController;
    ...
    const-string p0, ": Route selected"
...
.method onSetDiscoveryRequest(Landroid/os/Messenger;ILandroidx/mediarouter/media/MediaRouteDiscoveryRequest;)Z
    ...
    iget-object p0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->mCompositeDiscoveryRequest:Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;
...
.method onSetRouteVolume(Landroid/os/Messenger;III)Z
    ...
    const-string p0, ": Route volume changed"
...
.method onUnselectRoute(Landroid/os/Messenger;III)Z
    ...
    const-string p0, ": Route unselected"
...
.method onUpdateRouteVolume(Landroid/os/Messenger;III)Z
    ...
    const-string p0, ": Route volume updated"
...
.method updateCompositeDiscoveryRequest()Z
    ...
    invoke-direct {v3, v7}, Landroidx/mediarouter/media/MediaRouteSelector$Builder;-><init>(Landroidx/mediarouter/media/MediaRouteSelector;)V
    ...
    invoke-direct {v5, v0, v4}, Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;-><init>(Landroidx/mediarouter/media/MediaRouteSelector;Z)V
    ...
    invoke-static {v0, v5}, Landroidx/core/util/ObjectsCompat;->equals(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 469
    iput-object v5, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->mCompositeDiscoveryRequest:Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;

    .line 470
    iget-object p0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->mProvider:Landroidx/mediarouter/media/MediaRouteProvider;

    invoke-virtual {p0, v5}, Landroidx/mediarouter/media/MediaRouteProvider;->setDiscoveryRequest(Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;)V
