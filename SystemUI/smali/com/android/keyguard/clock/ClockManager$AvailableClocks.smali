...
.method private getClockPlugin()Lcom/android/systemui/plugins/ClockPlugin;
    ...
    invoke-static {v0}, Lcom/android/keyguard/clock/ClockManager;->access$300(Lcom/android/keyguard/clock/ClockManager;)Lcom/android/keyguard/clock/SettingsWrapper;
    ...
    invoke-static {v1}, Lcom/android/keyguard/clock/ClockManager;->access$300(Lcom/android/keyguard/clock/ClockManager;)Lcom/android/keyguard/clock/SettingsWrapper;
...
.method addClockPlugin(Lcom/android/systemui/plugins/ClockPlugin;)V
    ...
    new-instance v2, Lcom/android/keyguard/clock/-$$Lambda$d3U4w-CuqsezzeLGogc1fLHnUj0;

    invoke-direct {v2, p1}, Lcom/android/keyguard/clock/-$$Lambda$d3U4w-CuqsezzeLGogc1fLHnUj0;-><init>(Lcom/android/systemui/plugins/ClockPlugin;)V

    .line 365
    invoke-virtual {v0, v2}, Lcom/android/keyguard/clock/ClockInfo$Builder;->setThumbnail(Ljava/util/function/Supplier;)Lcom/android/keyguard/clock/ClockInfo$Builder;

    move-result-object v0

    new-instance v2, Lcom/android/keyguard/clock/-$$Lambda$ClockManager$AvailableClocks$3xFQeynnnUMh38fqZ7v9xTaqzmA;

    invoke-direct {v2, p0, p1}, Lcom/android/keyguard/clock/-$$Lambda$ClockManager$AvailableClocks$3xFQeynnnUMh38fqZ7v9xTaqzmA;-><init>(Lcom/android/keyguard/clock/ClockManager$AvailableClocks;Lcom/android/systemui/plugins/ClockPlugin;)V

    .line 366
    invoke-virtual {v0, v2}, Lcom/android/keyguard/clock/ClockInfo$Builder;->setPreview(Ljava/util/function/Supplier;)Lcom/android/keyguard/clock/ClockInfo$Builder;

    move-result-object p0

    .line 367
    invoke-virtual {p0}, Lcom/android/keyguard/clock/ClockInfo$Builder;->build()Lcom/android/keyguard/clock/ClockInfo;
...
.method public synthetic lambda$addClockPlugin$0$ClockManager$AvailableClocks(Lcom/android/systemui/plugins/ClockPlugin;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0}, Lcom/android/keyguard/clock/ClockManager;->access$400(Lcom/android/keyguard/clock/ClockManager;)I
    ...
    invoke-static {p0}, Lcom/android/keyguard/clock/ClockManager;->access$500(Lcom/android/keyguard/clock/ClockManager;)I
