...
# static fields
.field private static final BUBBLE_BOUNCINESS:Ljava/lang/String; = "experiment_bubble_bounciness"

.field private static final BUBBLE_STIFFNESS:Ljava/lang/String; = "experiment_bubble_stiffness"

.field private static final DEBUG:Z = false

.field public static final DEBUG_ENABLE_AUTO_BUBBLE:Z = false

.field static final DISMISS_ACCESSIBILITY_ACTION:I = 0x6

.field static final DISMISS_AGED:I = 0x2

.field static final DISMISS_BLOCKED:I = 0x4

.field static final DISMISS_NOTIF_CANCEL:I = 0x5

.field static final DISMISS_NO_LONGER_BUBBLE:I = 0x7

.field static final DISMISS_TASK_FINISHED:I = 0x3

.field static final DISMISS_USER_GESTURE:I = 0x1

.field private static final ENABLE_AUTO_BUBBLE_ALL:Ljava/lang/String; = "experiment_autobubble_all"

.field private static final ENABLE_AUTO_BUBBLE_MESSAGES:Ljava/lang/String; = "experiment_autobubble_messaging"

.field private static final ENABLE_AUTO_BUBBLE_ONGOING:Ljava/lang/String; = "experiment_autobubble_ongoing"

.field private static final ENABLE_BUBBLES:Ljava/lang/String; = "experiment_enable_bubbles"

.field private static final ENABLE_BUBBLE_CONTENT_INTENT:Ljava/lang/String; = "experiment_bubble_content_intent"

.field public static final MAX_BUBBLES:I = 0x5

.field private static final TAG:Ljava/lang/String; = "BubbleController"
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/StatusBarWindowController;Lcom/android/systemui/bubbles/BubbleData;Lcom/android/systemui/bubbles/BubbleStackView$SurfaceSynchronizer;Lcom/android/systemui/statusbar/policy/ConfigurationController;Lcom/android/systemui/statusbar/notification/NotificationInterruptionStateProvider;Lcom/android/systemui/statusbar/policy/ZenModeController;)V
    ...
    invoke-interface {p1, p6}, Lcom/android/systemui/statusbar/policy/ZenModeController;->addCallback(Ljava/lang/Object;)V

    .line 239
    invoke-interface {p5, p0}, Lcom/android/systemui/statusbar/policy/ConfigurationController;->addCallback(Ljava/lang/Object;)V
...
.method static formatBubblesString(Ljava/util/List;Lcom/android/systemui/bubbles/Bubble;)Ljava/lang/String;
    .locals 6
    ...
    .line 745
    invoke-virtual {v1}, Lcom/android/systemui/bubbles/Bubble;->getLastActivity()J
    ...
    .line 746
    invoke-virtual {v1}, Lcom/android/systemui/bubbles/Bubble;->isOngoing()Z
    ...
    const-string v1, "%s Bubble{act=%12d, ongoing=%d, key=%s}\n"
...
.method public static getBubbleBounciness(Landroid/content/Context;F)F
    .locals 2
    ...
    const-string v1, "experiment_bubble_bounciness"

    .line 831
    invoke-static {p0, v1, p1}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
...
.method public static getBubbleStiffness(Landroid/content/Context;I)I
    .locals 1
    ...
    const-string v0, "experiment_bubble_stiffness"
...
.method static shouldUseContentIntent(Landroid/content/Context;)Z
    .locals 2
    ...
    const-string v1, "experiment_bubble_content_intent"
...
.method public getTouchableRegion()Landroid/graphics/Rect;
    ...
    invoke-virtual {v0}, Lcom/android/systemui/bubbles/BubbleStackView;->getVisibility()I
...
.method public updateStack()V
    ...
    :cond_1
    invoke-virtual {v0, v2}, Lcom/android/systemui/bubbles/BubbleStackView;->setVisibility(I)V
    ...
    invoke-virtual {v2}, Lcom/android/systemui/bubbles/BubbleStackView;->getVisibility()I
