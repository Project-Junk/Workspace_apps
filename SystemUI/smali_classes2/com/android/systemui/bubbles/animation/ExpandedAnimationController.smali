...
# static fields
.field private static final ANIMATE_SCALE_PERCENT:F = 0.5f
...
.field private mCollapseToPoint:Landroid/graphics/PointF;
...
.method private animateStackByBubbleWidthsStartingFrom(II)V
    .locals 1

    .line 285
    new-instance v0, Lcom/android/systemui/bubbles/animation/-$$Lambda$ExpandedAnimationController$wS6mPYbsm-czFPLN0u9Fwoek3-A;

    invoke-direct {v0, p0, p1}, Lcom/android/systemui/bubbles/animation/-$$Lambda$ExpandedAnimationController$wS6mPYbsm-czFPLN0u9Fwoek3-A;-><init>(Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;I)V

    invoke-virtual {p0, p2, v0}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationsForChildrenFromIndex(ILcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController$ChildAnimationConfigurator;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController$MultiAnimationStarter;
...
.method private getRowLeft()F
    ...
    .line 429
    iget-object v0, p0, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
...
.method private startOrUpdateCollapseAnimation()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationsForChildrenFromIndex(ILcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController$ChildAnimationConfigurator;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController$MultiAnimationStarter;
...
.method private startOrUpdateExpandAnimation()V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationsForChildrenFromIndex(ILcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController$ChildAnimationConfigurator;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController$MultiAnimationStarter;
...
.method private updateBubblePositions()V
    ...
    .line 399
    :goto_0
    iget-object v2, p0, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
    ...
    .line 408
    :cond_1
    invoke-virtual {p0, v2}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationForChild(Landroid/view/View;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public demagnetizeBubbleTo(FFFF)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationForChild(Landroid/view/View;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public dismissDraggedOutBubble(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    .line 205
    invoke-virtual {p0, p1}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationForChild(Landroid/view/View;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public dragBubbleOut(Landroid/view/View;FF)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationForChild(Landroid/view/View;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public getExpandedY()F
    ...
    invoke-virtual {v0}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getRootWindowInsets()Landroid/view/WindowInsets;
...
.method public synthetic lambda$animateStackByBubbleWidthsStartingFrom$6$ExpandedAnimationController(IILcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;)V
    .locals 0
    ...
    invoke-virtual {p3, p0, p1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->translationX(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public synthetic lambda$startOrUpdateCollapseAnimation$2$ExpandedAnimationController(FILcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;)V
    ...
    iget p2, p0, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->mStackOffsetPx:F
    ...
    invoke-virtual {p3, v0, p0, p1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->position(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public magnetBubbleToDismiss(Landroid/view/View;FFFLjava/lang/Runnable;)V
    ...
    iget-object p2, p0, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;

    .line 228
    invoke-virtual {p2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getWidth()I
    ...
    .line 229
    invoke-virtual {p0, p4, p1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->translationY(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method onActiveControllerForLayout(Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;)V
    ...
    .line 307
    invoke-virtual {p1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getResources()Landroid/content/res/Resources;
    ...
    .line 317
    iget-object p1, p0, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->setVisibility(I)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationsForChildrenFromIndex(ILcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController$ChildAnimationConfigurator;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController$MultiAnimationStarter;
...
.method onChildRemoved(Landroid/view/View;ILjava/lang/Runnable;)V
    ...
    .line 379
    invoke-virtual {p1, p2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->withDampingRatio(F)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    .line 380
    invoke-virtual {p1, p3, p2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->scaleX(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    .line 381
    invoke-virtual {p1, p3, p2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->scaleY(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public snapBubbleBack(Landroid/view/View;FF)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->indexOfChild(Landroid/view/View;)I

    move-result v0

    .line 256
    invoke-virtual {p0, v0}, Lcom/android/systemui/bubbles/animation/ExpandedAnimationController;->animationForChildAtIndex(I)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    .line 258
    invoke-virtual {v0, p2, p3}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->withPositionStartVelocities(FF)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    new-instance v0, Lcom/android/systemui/bubbles/animation/-$$Lambda$ExpandedAnimationController$N9wvaPtVhtSOeiJ2KFEP39-mzf4;

    invoke-direct {v0, p1}, Lcom/android/systemui/bubbles/animation/-$$Lambda$ExpandedAnimationController$N9wvaPtVhtSOeiJ2KFEP39-mzf4;-><init>(Landroid/view/View;)V

    aput-object v0, p3, v3

    .line 259
    invoke-virtual {p2, p3}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->start([Ljava/lang/Runnable;)V
