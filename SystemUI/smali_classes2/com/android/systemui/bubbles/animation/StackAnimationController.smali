...
# static fields
.field private static final ANIMATE_IN_STARTING_SCALE:F = 1.15f

.field private static final ANIMATE_TRANSLATION_FACTOR:I = 0x4

.field private static final DEFAULT_BOUNCINESS:F = 0.9f

.field private static final DEFAULT_STIFFNESS:I = 0x2ee0

.field private static final ESCAPE_VELOCITY:F = 750.0f

.field private static final FLING_FOLLOW_STIFFNESS:I = 0x4e20

.field private static final FLING_FRICTION_X:F = 2.2f

.field private static final FLING_FRICTION_Y:F = 2.2f

.field private static final SPRING_AFTER_FLING_DAMPING_RATIO:F = 0.85f

.field private static final SPRING_AFTER_FLING_STIFFNESS:I = 0x2ee
...
.method private animateInBubble(Landroid/view/View;)V
    ...
    .line 746
    invoke-virtual {p0}, Lcom/android/systemui/bubbles/animation/StackAnimationController;->isActiveController()Z
    ...
    .line 753
    invoke-virtual {p0, p1}, Lcom/android/systemui/bubbles/animation/StackAnimationController;->animationForChild(Landroid/view/View;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    .line 757
    invoke-virtual {p1, v2, p0, v0}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->translationX(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method private moveFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
    ...
    .line 704
    invoke-virtual {p0, v2}, Lcom/android/systemui/bubbles/animation/StackAnimationController;->animationForChildAtIndex(I)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method private moveStackToStartPosition()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->setVisibility(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->post(Ljava/lang/Runnable;)Z
...
.method private setStackPosition(Landroid/graphics/PointF;)V
    ...
    .line 726
    :goto_0
    iget-object v3, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;

    invoke-virtual {v3}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getChildCount()I
...
.method public animateForImeVisibility(Z)V
    ...
    iget p1, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mPreImeY:F
    ...
    .line 404
    invoke-virtual {p0, v1, v2}, Lcom/android/systemui/bubbles/animation/StackAnimationController;->getSpringForce(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroid/view/View;)Landroidx/dynamicanimation/animation/SpringForce;
...
.method public cancelStackPositionAnimations()V
    ...
    .line 372
    iget-object p0, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
...
.method public flingStackThenSpringToEdge(FFF)F
    ...
    iget-object v2, v6, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;

    invoke-virtual {v2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getWidth()I
    ...
    .line 265
    iget-object v0, v6, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
...
.method protected flingThenSpringFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;FFLandroidx/dynamicanimation/animation/SpringForce;Ljava/lang/Float;)V
    ...
    new-instance v11, Lcom/android/systemui/bubbles/animation/-$$Lambda$StackAnimationController$RhB8H-puZAhRpI0Km19AlqvKSuI;
...
.method public getAllowableStackPositionRegion()Landroid/graphics/RectF;
    ...
    .line 428
    iget-object v2, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
    ...
    .line 446
    invoke-virtual {v2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getHeight()I
...
.method getOffsetForChainedPropertyAnimation(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;)F
    ...
    .line 606
    :cond_0
    iget-object p1, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
...
.method public getStackPositionAlongNearestHorizontalEdge()Landroid/graphics/PointF;
    ...
    .line 285
    iget-object v1, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;
...
.method public implodeStack(Ljava/lang/Runnable;)V
    ...
    .line 533
    invoke-virtual {p0, v0}, Lcom/android/systemui/bubbles/animation/StackAnimationController;->animationForChildAtIndex(I)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method public isStackOnLeftSide()Z
    ...
    invoke-virtual {p0}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getWidth()I
...
.method public magnetToDismiss(FFFLjava/lang/Runnable;)V
    ...
    .line 519
    invoke-virtual {p0, v1}, Lcom/android/systemui/bubbles/animation/StackAnimationController;->animationForChildAtIndex(I)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    .line 520
    invoke-virtual {v3}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getWidth()I
    ...
    .line 521
    invoke-virtual {p0, p3, v0}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->translationY(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;

    move-result-object p0

    .line 522
    invoke-virtual {p0, p1, p2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->withPositionStartVelocities(FF)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    .line 524
    invoke-virtual {p0, p1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->withDampingRatio(F)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
...
.method onChildAdded(Landroid/view/View;I)V
    ...
    .line 623
    iget-object p2, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mLayout:Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;

    invoke-virtual {p2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getChildCount()I
    ...
    invoke-virtual {p2, p1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->indexOfChild(Landroid/view/View;)I
...
.method onChildRemoved(Landroid/view/View;ILjava/lang/Runnable;)V
    ...
    invoke-virtual {p1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout;->getChildCount()I
