...
.field private static final MAX_X_SECONDARY_DEVIANCE:F = 0.3f

.field private static final MAX_Y_PRIMARY_DEVIANCE:F = 0.05f
...
.method constructor <init>(Lcom/android/systemui/classifier/brightline/FalsingDataProvider;)V
    ...
    const-string v1, "brightline_falsing_zigzag_x_primary_deviance"
    ...
    iput v1, p0, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->mMaxXPrimaryDeviance:F

    const-string v1, "brightline_falsing_zigzag_y_primary_deviance"
    ...
    iput p1, p0, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->mMaxYPrimaryDeviance:F

    const p1, 0x3e99999a    # 0.3f

    const-string v1, "brightline_falsing_zigzag_x_secondary_deviance"
    ...
    iput v1, p0, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->mMaxXSecondaryDeviance:F

    const-string v1, "brightline_falsing_zigzag_y_secondary_deviance"
...
.method private getAtan2LastPoint()F
    ...
    .line 146
    invoke-virtual {p0}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->getFirstMotionEvent()Landroid/view/MotionEvent;

    move-result-object v0

    .line 147
    invoke-virtual {p0}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->getLastMotionEvent()Landroid/view/MotionEvent;
...
.method private rotateHorizontal()Ljava/util/List;
    ...
    invoke-static {v2}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->logDebug(Ljava/lang/String;)V

    .line 167
    invoke-virtual {p0}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->getRecentMotionEvents()Ljava/util/List;
...
.method private rotateMotionEvents(Ljava/util/List;D)Ljava/util/List;
    ...
    .line 188
    invoke-static {v4}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->logDebug(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->logDebug(Ljava/lang/String;)V
...
.method isFalseTouch()Z
    ...
    .line 92
    :cond_0
    invoke-virtual {p0}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->isHorizontal()Z
    ...
    invoke-static {v5}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->logDebug(Ljava/lang/String;)V
    ...
    invoke-static {v12}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->logDebug(Ljava/lang/String;)V
    ...
    .line 125
    invoke-virtual {p0}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->getXdpi()F
    ...
    .line 126
    invoke-virtual {p0}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->getYdpi()F
    ...
    invoke-static {p0}, Lcom/android/systemui/classifier/brightline/ZigZagClassifier;->logDebug(Ljava/lang/String;)V
