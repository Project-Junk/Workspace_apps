...
.method public constructor <init>(Lcom/android/systemui/egg/MLand;Landroid/content/Context;F)V
    ...
    .line 1246
    invoke-virtual {p0, p3}, Lcom/android/systemui/egg/MLand$Pop;->setBackgroundResource(I)V

    .line 1247
    sget-object p3, Lcom/android/systemui/egg/MLand;->ANTENNAE:[I

    invoke-static {p3}, Lcom/android/systemui/egg/MLand;->pick([I)I
    ...
    iput-object p3, p0, Lcom/android/systemui/egg/MLand$Pop;->antenna:Landroid/graphics/drawable/Drawable;
    ...
    .line 1249
    sget-object p3, Lcom/android/systemui/egg/MLand;->EYES:[I
    ...
    iput-object p3, p0, Lcom/android/systemui/egg/MLand$Pop;->eyes:Landroid/graphics/drawable/Drawable;
    ...
    .line 1251
    sget-object p3, Lcom/android/systemui/egg/MLand;->MOUTHS:[I
    ...
    iput-object p2, p0, Lcom/android/systemui/egg/MLand$Pop;->mouth:Landroid/graphics/drawable/Drawable;

    .line 1254
    :cond_0
    new-instance p2, Lcom/android/systemui/egg/MLand$Pop$1;

    invoke-direct {p2, p0, p1}, Lcom/android/systemui/egg/MLand$Pop$1;-><init>(Lcom/android/systemui/egg/MLand$Pop;Lcom/android/systemui/egg/MLand;)V

    invoke-virtual {p0, p2}, Lcom/android/systemui/egg/MLand$Pop;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V
...
.method public intersects(Lcom/android/systemui/egg/MLand$Player;)Z
    ...
    iget v3, p0, Lcom/android/systemui/egg/MLand$Pop;->cy:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1298
    iget-object p0, p0, Lcom/android/systemui/egg/MLand$Pop;->mouth:Landroid/graphics/drawable/Drawable;
...
.method public step(JJFF)V
    ...
    .line 1276
    iget p1, p0, Lcom/android/systemui/egg/MLand$Pop;->mRotate:I
    ...
    iget p2, p0, Lcom/android/systemui/egg/MLand$Pop;->mRotate:I
    ...
    invoke-virtual {p0, p1}, Lcom/android/systemui/egg/MLand$Pop;->setRotation(F)V

    .line 1280
    :cond_0
    iget-object p1, p0, Lcom/android/systemui/egg/MLand$Pop;->hitRect:Landroid/graphics/Rect;

    iget p1, p1, Landroid/graphics/Rect;->left:I

    iget-object p2, p0, Lcom/android/systemui/egg/MLand$Pop;->hitRect:Landroid/graphics/Rect;
    ...
    iput p1, p0, Lcom/android/systemui/egg/MLand$Pop;->cx:I
    ...
    iput p1, p0, Lcom/android/systemui/egg/MLand$Pop;->cy:I
    ...
    iput p1, p0, Lcom/android/systemui/egg/MLand$Pop;->r:I
