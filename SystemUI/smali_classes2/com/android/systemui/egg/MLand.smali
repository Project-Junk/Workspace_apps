...
.field static final CONTROLLER_VIBRATION_MULTIPLIER:F = 2.0f
...
.field public static final DEBUG_SPEED_MULTIPLIER:F = 0.5f

.field public static final DEFAULT_PLAYERS:I = 0x1

.field static final EYES:[I

.field public static final HAVE_STARS:Z = true

.field public static final MAX_PLAYERS:I = 0x6

.field public static final MIN_PLAYERS:I = 0x1
...
.field private static PARAMS:Lcom/android/systemui/egg/MLand$Params; = null

.field public static final PI_2:F = 1.5707964f

.field private static final SCENE_CITY:I = 0x0

.field private static final SCENE_COUNT:I = 0x3

.field private static final SCENE_TX:I = 0x1

.field private static final SCENE_ZRH:I = 0x2

.field public static final SHOW_TOUCHES:Z = true

.field private static final SKIES:[[I

.field private static final SUNSET:I = 0x3

.field public static final TAG:Ljava/lang/String; = "MLand"
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 195
    invoke-virtual {p0, p1}, Lcom/android/systemui/egg/MLand;->setFocusable(Z)V
    ...
    .line 210
    invoke-virtual {p0, p2}, Lcom/android/systemui/egg/MLand;->setLayoutDirection(I)V
...
.method private poke(IFF)V
    ...
    .line 921
    invoke-virtual {p1}, Lcom/android/systemui/egg/MLand$Player;->animate()Landroid/view/ViewPropertyAnimator;
...
.method private step(JJ)V
    ...
    invoke-virtual {v0, v8, v9}, Lcom/android/systemui/egg/MLand;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationX(F)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationY(F)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationZ(F)V

    .line 766
    invoke-virtual {v8}, Lcom/android/systemui/egg/MLand$Obstacle;->animate()Landroid/view/ViewPropertyAnimator;
    ...
    iget v2, v2, Lcom/android/systemui/egg/MLand$Params;->OBSTACLE_WIDTH:I

    invoke-direct {v9, v11, v2, v12}, Landroid/widget/FrameLayout$LayoutParams;-><init>(III)V

    invoke-virtual {v0, v3, v9}, Lcom/android/systemui/egg/MLand;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    .line 777
    iget v2, v0, Lcom/android/systemui/egg/MLand;->mWidth:I

    int-to-float v2, v2

    invoke-virtual {v3, v2}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationX(F)V
    ...
    invoke-virtual {v3, v2}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationY(F)V

    .line 779
    sget-object v2, Lcom/android/systemui/egg/MLand;->PARAMS:Lcom/android/systemui/egg/MLand$Params;

    iget v2, v2, Lcom/android/systemui/egg/MLand$Params;->OBSTACLE_Z:F

    invoke-virtual {v3, v2}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationZ(F)V

    const/high16 v2, 0x3e800000    # 0.25f

    .line 780
    invoke-virtual {v3, v2}, Lcom/android/systemui/egg/MLand$Obstacle;->setScaleX(F)V

    const/high16 v9, -0x41800000    # -0.25f

    .line 781
    invoke-virtual {v3, v9}, Lcom/android/systemui/egg/MLand$Obstacle;->setScaleY(F)V
    ...
    .line 783
    invoke-virtual {v9, v8}, Landroid/view/ViewPropertyAnimator;->translationY(F)Landroid/view/ViewPropertyAnimator;
    ...
    invoke-direct {v6, v0, v7, v1, v8}, Lcom/android/systemui/egg/MLand$Stem;-><init>(Lcom/android/systemui/egg/MLand;Landroid/content/Context;FZ)V
    ...
    iget v7, v7, Lcom/android/systemui/egg/MLand$Params;->OBSTACLE_STEM_WIDTH:I

    iget v8, v6, Lcom/android/systemui/egg/MLand$Obstacle;->h:F

    float-to-int v8, v8

    invoke-direct {v1, v7, v8, v12}, Landroid/widget/FrameLayout$LayoutParams;-><init>(III)V

    invoke-virtual {v0, v6, v1}, Lcom/android/systemui/egg/MLand;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v6, v1}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationX(F)V
    ...
    invoke-virtual {v6, v1}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationY(F)V
    ...
    invoke-virtual {v6, v1}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationZ(F)V
    ...
    iget v5, v6, Lcom/android/systemui/egg/MLand$Obstacle;->h:F
    ...
    invoke-direct {v1, v0, v5, v11}, Lcom/android/systemui/egg/MLand$Pop;-><init>(Lcom/android/systemui/egg/MLand;Landroid/content/Context;F)V
    ...
    iget v13, v13, Lcom/android/systemui/egg/MLand$Params;->OBSTACLE_WIDTH:I

    invoke-direct {v5, v11, v13, v12}, Landroid/widget/FrameLayout$LayoutParams;-><init>(III)V

    invoke-virtual {v0, v1, v5}, Lcom/android/systemui/egg/MLand;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    .line 812
    iget v5, v0, Lcom/android/systemui/egg/MLand;->mWidth:I

    int-to-float v5, v5

    invoke-virtual {v1, v5}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationX(F)V

    .line 813
    iget v5, v0, Lcom/android/systemui/egg/MLand;->mHeight:I

    int-to-float v5, v5

    invoke-virtual {v1, v5}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationY(F)V

    .line 814
    sget-object v5, Lcom/android/systemui/egg/MLand;->PARAMS:Lcom/android/systemui/egg/MLand$Params;

    iget v5, v5, Lcom/android/systemui/egg/MLand$Params;->OBSTACLE_Z:F

    invoke-virtual {v1, v5}, Lcom/android/systemui/egg/MLand$Obstacle;->setTranslationZ(F)V

    .line 815
    invoke-virtual {v1, v2}, Lcom/android/systemui/egg/MLand$Obstacle;->setScaleX(F)V

    .line 816
    invoke-virtual {v1, v2}, Lcom/android/systemui/egg/MLand$Obstacle;->setScaleY(F)V

    .line 817
    invoke-virtual {v1}, Lcom/android/systemui/egg/MLand$Obstacle;->animate()Landroid/view/ViewPropertyAnimator;
...
.method public getGameWidth()I
    ...
    .line 233
    iget p0, p0, Lcom/android/systemui/egg/MLand;->mWidth:I
...
.method public getLastTimeStep()F
    ...
    .line 236
    iget p0, p0, Lcom/android/systemui/egg/MLand;->dt:F
...
.method public reset()V
    ...
    .line 394
    invoke-virtual {p0, v1}, Lcom/android/systemui/egg/MLand;->setBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_1
    invoke-virtual {p0, v1}, Lcom/android/systemui/egg/MLand;->setScaleX(F)V

    .line 399
    invoke-virtual {p0}, Lcom/android/systemui/egg/MLand;->getChildCount()I
    ...
    .line 401
    invoke-virtual {p0, v6}, Lcom/android/systemui/egg/MLand;->getChildAt(I)Landroid/view/View;
    ...
    .line 403
    invoke-virtual {p0, v6}, Lcom/android/systemui/egg/MLand;->removeViewAt(I)V
    ...
    .line 411
    invoke-virtual {p0}, Lcom/android/systemui/egg/MLand;->getHeight()I
    ...
    .line 415
    new-instance v9, Lcom/android/systemui/egg/MLand$Star;

    invoke-virtual {p0}, Lcom/android/systemui/egg/MLand;->getContext()Landroid/content/Context;

    move-result-object v10

    invoke-direct {v9, p0, v10}, Lcom/android/systemui/egg/MLand$Star;-><init>(Lcom/android/systemui/egg/MLand;Landroid/content/Context;)V

    const v10, 0x7f0811ff

    .line 416
    invoke-virtual {v9, v10}, Lcom/android/systemui/egg/MLand$Star;->setBackgroundResource(I)V
    ...
    .line 418
    iget v12, p0, Lcom/android/systemui/egg/MLand;->mWidth:I

    sub-int/2addr v12, v10

    int-to-float v12, v12

    invoke-static {v11, v12}, Lcom/android/systemui/egg/MLand;->frand(FF)F

    move-result v12

    invoke-virtual {v9, v12}, Lcom/android/systemui/egg/MLand$Star;->setTranslationX(F)V

    .line 419
    iget v12, p0, Lcom/android/systemui/egg/MLand;->mTimeOfDay:I
    ...
    .line 420
    iget v12, p0, Lcom/android/systemui/egg/MLand;->mHeight:I
    ...
    invoke-virtual {v9, v11}, Lcom/android/systemui/egg/MLand$Star;->setTranslationY(F)V

    .line 421
    invoke-virtual {v9}, Lcom/android/systemui/egg/MLand$Star;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v12, v11}, Lcom/android/systemui/egg/MLand;->frand(FF)F
    ...
    invoke-virtual {v11, v12}, Landroid/graphics/drawable/Drawable;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    const v12, -0x3f008000    # -7.984375f
    ...
    invoke-virtual {p0, v9, v11}, Lcom/android/systemui/egg/MLand;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-direct {v3, p0, v10}, Lcom/android/systemui/egg/MLand$Star;-><init>(Lcom/android/systemui/egg/MLand;Landroid/content/Context;)V

    const v10, 0x7f080d97

    .line 435
    invoke-virtual {v3, v10}, Lcom/android/systemui/egg/MLand$Star;->setBackgroundResource(I)V

    .line 436
    invoke-virtual {v3}, Lcom/android/systemui/egg/MLand$Star;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    :goto_8
    invoke-virtual {v3, v4}, Lcom/android/systemui/egg/MLand$Star;->setScaleX(F)V

    .line 438
    invoke-virtual {v3}, Lcom/android/systemui/egg/MLand$Star;->getScaleX()F
    ...
    invoke-static {v4, v10}, Lcom/android/systemui/egg/MLand;->frand(FF)F

    move-result v4

    mul-float/2addr v1, v4

    invoke-virtual {v3, v1}, Lcom/android/systemui/egg/MLand$Star;->setRotation(F)V
    ...
    .line 440
    iget v8, p0, Lcom/android/systemui/egg/MLand;->mWidth:I

    sub-int/2addr v8, v1

    int-to-float v8, v8

    invoke-static {v4, v8}, Lcom/android/systemui/egg/MLand;->frand(FF)F

    move-result v8

    invoke-virtual {v3, v8}, Lcom/android/systemui/egg/MLand$Star;->setTranslationX(F)V

    .line 441
    iget v8, p0, Lcom/android/systemui/egg/MLand;->mHeight:I
    ...
    invoke-virtual {v3, v4}, Lcom/android/systemui/egg/MLand$Star;->setTranslationY(F)V
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/systemui/egg/MLand;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 474
    invoke-virtual {v4, v6}, Lcom/android/systemui/egg/MLand$Scenery;->setBackgroundColor(I)V
    ...
    .line 478
    invoke-virtual {v4}, Lcom/android/systemui/egg/MLand$Scenery;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    iget v8, v4, Lcom/android/systemui/egg/MLand$Scenery;->h:I
    ...
    .line 487
    instance-of v8, v4, Lcom/android/systemui/egg/MLand$Star;
    ...
    .line 495
    :goto_c
    invoke-virtual {p0, v4, v6}, Lcom/android/systemui/egg/MLand;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v4, v6}, Lcom/android/systemui/egg/MLand$Scenery;->setTranslationX(F)V
    ...
    .line 500
    invoke-virtual {p0, v1}, Lcom/android/systemui/egg/MLand;->addView(Landroid/view/View;)V
...
.method public start(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/systemui/egg/MLand;->post(Ljava/lang/Runnable;)Z
    ...
    .line 547
    invoke-virtual {v1, v2}, Lcom/android/systemui/egg/MLand$Player;->setVisibility(I)V
