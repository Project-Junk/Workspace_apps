...
.field private static final GLOBAL_ACTION_KEY_EMERGENCY:Ljava/lang/String; = "emergency"
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/plugins/GlobalActions$GlobalActionsManager;)V
    ...
    sget v0, Lcom/coloros/common/util/ResourceUtil;->android_bool_config_useFixedVolume:I
...
.method private addUsersToMenu(Ljava/util/ArrayList;)V
    ...
    sget v5, Lcom/coloros/common/util/ResourceUtil;->android_drawable_ic_menu_cc:I
...
.method private createDialog()Lcom/android/systemui/globalactions/GlobalActionsDialog$ActionsDialog;
    ...
    sget v5, Lcom/coloros/common/util/ResourceUtil;->android_drawable_ic_lock_airplane_mode:I

    sget v6, Lcom/coloros/common/util/ResourceUtil;->android_drawable_ic_lock_airplane_mode_off:I

    sget v7, Lcom/coloros/common/util/ResourceUtil;->android_string_global_actions_toggle_airplane_mode:I

    sget v8, Lcom/coloros/common/util/ResourceUtil;->android_string_global_actions_airplane_mode_on_status:I

    sget v9, Lcom/coloros/common/util/ResourceUtil;->android_string_global_actions_airplane_mode_off_status:I
    ...
    sget v1, Lcom/coloros/common/util/ResourceUtil;->android_array_config_globalActionsList:I
    ...
    .line 434
    invoke-virtual {v0, v2}, Lcom/android/systemui/globalactions/GlobalActionsDialog$ActionsDialog;->setCanceledOnTouchOutside(Z)V
    ...
    .line 437
    invoke-virtual {v0, p0}, Lcom/android/systemui/globalactions/GlobalActionsDialog$ActionsDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    .line 438
    invoke-virtual {v0, p0}, Lcom/android/systemui/globalactions/GlobalActionsDialog$ActionsDialog;->setOnShowListener(Landroid/content/DialogInterface$OnShowListener;)V
...
.method private getAssistAction()Lcom/android/systemui/globalactions/GlobalActionsDialog$Action;
    ...
    sget v1, Lcom/coloros/common/util/ResourceUtil;->android_drawable_ic_action_assist_focused:I

    sget v2, Lcom/coloros/common/util/ResourceUtil;->android_drawable_global_action_assist:I
...
.method private getLockdownAction()Lcom/android/systemui/globalactions/GlobalActionsDialog$Action;
    ...
    sget v1, Lcom/coloros/common/util/ResourceUtil;->android_drawable_ic_lock_lockdown:I

    sget v2, Lcom/coloros/common/util/ResourceUtil;->android_string_global_action_lockdown:I
...
.method private getSettingsAction()Lcom/android/systemui/globalactions/GlobalActionsDialog$Action;
    ...
    sget v1, Lcom/coloros/common/util/ResourceUtil;->android_string_global_action_settings:I

    const v2, 0x7f08090e

    invoke-direct {v0, p0, v2, v1}, Lcom/android/systemui/globalactions/GlobalActionsDialog$3;-><init>(Lcom/android/systemui/globalactions/GlobalActionsDialog;II)V
...
.method private getVoiceAssistAction()Lcom/android/systemui/globalactions/GlobalActionsDialog$Action;
    ...
    sget v1, Lcom/coloros/common/util/ResourceUtil;->android_drawable_ic_voice_search:I

    sget v2, Lcom/coloros/common/util/ResourceUtil;->android_string_global_action_voice_assist:I
