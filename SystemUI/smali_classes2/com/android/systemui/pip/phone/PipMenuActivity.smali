...
.field private static final DISMISS_BACKGROUND_ALPHA:F = 0.6f

.field private static final INITIAL_DISMISS_DELAY:I = 0xdac

.field private static final MENU_BACKGROUND_ALPHA:F = 0.3f

.field private static final MENU_FADE_DURATION:J = 0x7dL

.field public static final MESSAGE_ANIMATION_ENDED:I = 0x6

.field public static final MESSAGE_HIDE_MENU:I = 0x3

.field public static final MESSAGE_POKE_MENU:I = 0x2

.field public static final MESSAGE_SHOW_MENU:I = 0x1

.field public static final MESSAGE_UPDATE_ACTIONS:I = 0x4

.field public static final MESSAGE_UPDATE_DISMISS_FRACTION:I = 0x5

.field private static final POST_INTERACTION_DISMISS_DELAY:I = 0x7d0

.field private static final TAG:Ljava/lang/String; = "PipMenuActivity"
...
.method private hideMenu(Ljava/lang/Runnable;ZZ)V
    ...
    iget-object v7, p0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mSettingsButton:Landroid/view/View;
    ...
    iget-object v8, p0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mDismissButton:Landroid/view/View;
...
.method private minimizePip()V
    .locals 2

    const/16 v0, 0x66

    const-string v1, "Could not notify controller to minimize PIP"
...
.method private showMenu(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
    ...
    iget-object v5, p0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mSettingsButton:Landroid/view/View;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 199
    invoke-virtual {p0, p1}, Lcom/android/systemui/pip/phone/PipMenuActivity;->setContentView(I)V

    .line 201
    const-class p1, Landroid/view/accessibility/AccessibilityManager;

    invoke-virtual {p0, p1}, Lcom/android/systemui/pip/phone/PipMenuActivity;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 204
    invoke-virtual {p0, p1}, Lcom/android/systemui/pip/phone/PipMenuActivity;->findViewById(I)Landroid/view/View;
    ...
    .line 252
    invoke-virtual {p0, p1}, Lcom/android/systemui/pip/phone/PipMenuActivity;->setTitle(I)V

    const/4 p1, 0x1

    .line 253
    invoke-virtual {p0, p1}, Lcom/android/systemui/pip/phone/PipMenuActivity;->setDisablePreviewScreenshots(Z)V
