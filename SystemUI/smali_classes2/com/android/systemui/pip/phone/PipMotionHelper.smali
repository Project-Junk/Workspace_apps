...
.field private static final DEFAULT_MOVE_STACK_DURATION:I = 0xe1

.field private static final DISMISS_OFFSCREEN_FRACTION:F = 0.3f

.field private static final DRAG_TO_DISMISS_STACK_DURATION:I = 0xaf

.field private static final DRAG_TO_TARGET_DISMISS_STACK_DURATION:I = 0x177

.field private static final EXPAND_STACK_TO_FULLSCREEN_DURATION:I = 0x12c

.field private static final EXPAND_STACK_TO_MENU_DURATION:I = 0xfa

.field private static final MINIMIZE_OFFSCREEN_FRACTION:F = 0.3f

.field private static final MINIMIZE_STACK_MAX_DURATION:I = 0xc8

.field private static final MSG_OFFSET_ANIMATE:I = 0x3

.field private static final MSG_RESIZE_ANIMATE:I = 0x2

.field private static final MSG_RESIZE_IMMEDIATE:I = 0x1
...
.field private static final SNAP_STACK_DURATION:I = 0xe1
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/app/IActivityTaskManager;Lcom/android/systemui/pip/phone/PipMenuActivityController;Lcom/android/internal/policy/PipSnapAlgorithm;Lcom/android/systemui/statusbar/FlingAnimationUtils;)V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/pip/phone/ForegroundThread;->getLooper()Landroid/os/Looper;
...
.method flingToMinimizedState(FLandroid/graphics/Rect;Landroid/graphics/Point;)Landroid/graphics/Rect;
    .locals 6
    ...
    invoke-direct {p0, p3, p2, v0, v1}, Lcom/android/systemui/pip/phone/PipMotionHelper;->createAnimationToBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;ILandroid/view/animation/Interpolator;)Landroid/animation/ValueAnimator;
    ...
    .line 257
    invoke-direct {p0, v2, p2}, Lcom/android/systemui/pip/phone/PipMotionHelper;->distanceBetweenRectOffsets(Landroid/graphics/Rect;Landroid/graphics/Rect;)F

    move-result v2

    .line 256
    invoke-virtual {p3, v0, v1, v2, p1}, Lcom/android/systemui/statusbar/FlingAnimationUtils;->apply(Landroid/animation/Animator;FFF)V
...
.method public isGestureToDismissArea(Landroid/graphics/Rect;FFZ)Z
    ...
    invoke-virtual {p0, p3}, Landroid/view/Display;->getRealSize(Landroid/graphics/Point;)V
    ...
    invoke-direct {p4, p0, v0, v1, p3}, Landroid/graphics/Rect;-><init>(IIII)V
