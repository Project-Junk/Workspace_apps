...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/policy/DeviceProvisionedController;Lcom/android/systemui/statusbar/NavigationBarController;Lcom/android/systemui/statusbar/phone/NavigationModeController;Lcom/android/systemui/statusbar/phone/StatusBarWindowController;)V
    ...
    const-string v2, "OverviewProxyService start"
    ...
    .line 514
    sget p2, Lcom/coloros/common/util/ResourceUtil;->android_string_config_recentsComponentName:I
...
.method static synthetic access$300(Lcom/android/systemui/recents/OverviewProxyService;)Ljava/util/List;
    .locals 0
...
.method static synthetic access$400(Lcom/android/systemui/recents/OverviewProxyService;)I
    .locals 0
...
.method static synthetic access$402(Lcom/android/systemui/recents/OverviewProxyService;I)I
    .locals 0
...
.method private dispatchNavButtonBounds()V
    ...
    const-string v1, "dispatchNavButtonBounds: , mActiveNavBarRegion not null: "
    ...
    const-string v1, ", mOverviewProxy not null: "
...
.method private internalConnectToCurrentUser()V
    ...
    .line 713
    :cond_0
    iget-object v1, p0, Lcom/android/systemui/recents/OverviewProxyService;->mHandler:Landroid/os/Handler;
...
.method private notifySystemUiStateFlags(I)V
    ...
    const-string v1, "notifySystemUiStateFlags: , flags: "
...
.method private onStatusBarStateChanged(ZZZ)V
    ...
    const-string v1, "onStatusBarStateChanged: , keyguardShowing: "
...
.method private updateSystemUiStateFlags()V
    ...
    const-string v2, "updateSystemUiStateFlags: "
...
.method public isOriginalGestureNavigation()Z
    .locals 1
...
.method public notifyAssistantVisibilityChanged(F)V
    ...
    const-string v0, "Failed to call onAssistantVisibilityChanged()"
...
.method public notifyBackAction(ZIIZZ)V
    ...
    const-string v1, "notifyBackAction: , completed: "
    ...
    invoke-interface/range {v2 .. v7}, Lcom/android/systemui/shared/recents/IOverviewProxy;->onBackAction(ZIIZZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string p1, "Failed to notify back action"
...
.method public setSystemUiStateFlag(IZI)V
    ...
    const-string v1, "setSystemUiStateFlag: , flag: "
...
.method public shouldShowSwipeUpUI()Z
    ...
    const-string v2, "shouldShowSwipeUpUI"
...
.method public startConnectionToCurrentUserIfNeeded()V
    .locals 2
    ...
    const-string v1, "skip redundant bind: mBound = "
    ...
    const-string v1, ", mCurrentBoundedUserId = "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/systemui/recents/OverviewProxyService;->mCurrentBoundedUserId:I
    ...
    const-string v1, ", mOverviewProxy = "
