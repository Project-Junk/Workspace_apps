...
.field private mLockscreenWallpaper:Lcom/coloros/systemui/keyguard/wallpaper/ILockScreenWallpaper;
...
.field private mMediaNotificationKeys:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.method public constructor <init>(Landroid/content/Context;Ldagger/Lazy;Ldagger/Lazy;Lcom/android/systemui/statusbar/notification/NotificationEntryManager;Lcom/android/systemui/statusbar/MediaArtworkProcessor;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mMediaNotificationKeys:Ljava/util/List;
...
.method private finishUpdateMediaMetaData(ZZLandroid/graphics/Bitmap;)V
    ...
    .line 656
    iget-object v4, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mLockscreenWallpaper:Lcom/coloros/systemui/keyguard/wallpaper/ILockScreenWallpaper;

    if-eqz v4, :cond_2

    invoke-interface {v4}, Lcom/coloros/systemui/keyguard/wallpaper/ILockScreenWallpaper;->getDrawable()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, v2}, Lcom/android/systemui/statusbar/BackDropView;->setVisibility(I)V
    ...
    invoke-virtual {p1, v9}, Lcom/android/systemui/statusbar/BackDropView;->setAlpha(F)V

    .line 687
    iget-object p1, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mBackdrop:Lcom/android/systemui/statusbar/BackDropView;

    invoke-virtual {p1}, Lcom/android/systemui/statusbar/BackDropView;->animate()Landroid/view/ViewPropertyAnimator;
    ...
    invoke-virtual {p1, v3}, Lcom/android/systemui/statusbar/BackDropView;->setAlpha(F)V
    ...
    invoke-virtual {p1}, Lcom/android/systemui/statusbar/BackDropView;->getVisibility()I
    ...
    .line 757
    invoke-static {p1}, Lcom/coloros/systemui/keyguard/view/KeyguardFakeAppLayer;->getInstance(Landroid/content/Context;)Lcom/coloros/systemui/keyguard/view/KeyguardFakeAppLayer;

    move-result-object p1

    invoke-virtual {p1}, Lcom/coloros/systemui/keyguard/view/KeyguardFakeAppLayer;->unlockWithoutTransition()Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/systemui/statusbar/BackDropView;->setVisibility(I)V
...
.method public findAndUpdateMediaNotificationsCustom()V
    .locals 15
    ...
    .line 386
    invoke-virtual {v8}, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->isMediaNotification()Z
    ...
    check-cast v9, Landroid/media/session/MediaSession$Token;

    if-eqz v9, :cond_0

    .line 391
    new-instance v10, Landroid/media/session/MediaController;

    iget-object v11, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mContext:Landroid/content/Context;

    invoke-direct {v10, v11, v9}, Landroid/media/session/MediaController;-><init>(Landroid/content/Context;Landroid/media/session/MediaSession$Token;)V
    ...
    .line 409
    invoke-virtual {v4, v7, v9}, Landroid/media/session/MediaSessionManager;->getActiveSessionsForUser(Landroid/content/ComponentName;I)Ljava/util/List;
    ...
    .line 427
    iget-object v13, v12, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->notification:Landroid/service/notification/StatusBarNotification;
    ...
    iget-object v13, v13, Landroid/app/Notification;->contentView:Landroid/widget/RemoteViews;
    ...
    .line 438
    :cond_5
    iget-object v13, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mMediaNotificationKeys:Ljava/util/List;

    iget-object v14, v12, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->notification:Landroid/service/notification/StatusBarNotification;
    ...
    iget-object v12, v12, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->notification:Landroid/service/notification/StatusBarNotification;
    ...
    invoke-direct {p0, v2, v10}, Lcom/android/systemui/statusbar/NotificationMediaManager;->sameSessions(Landroid/media/session/MediaController;Landroid/media/session/MediaController;)Z
    ...
    .line 450
    iput-object v10, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mMediaController:Landroid/media/session/MediaController;
    ...
    .line 461
    iget-object v2, v8, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->notification:Landroid/service/notification/StatusBarNotification;
...
.method public isMediaNotification(Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;)Z
    ...
    iget-object p0, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mMediaNotificationKeys:Ljava/util/List;
...
.method public onNotificationRemoved(Ljava/lang/String;)V
    ...
    .line 225
    invoke-direct {p0, v0, v0}, Lcom/android/systemui/statusbar/NotificationMediaManager;->dispatchUpdateMediaMetaData(ZZ)V
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mMediaNotificationKeys:Ljava/util/List;
...
.method public setup(Lcom/android/systemui/statusbar/BackDropView;Landroid/widget/ImageView;Landroid/widget/ImageView;Lcom/android/systemui/statusbar/phone/ScrimController;Lcom/coloros/systemui/keyguard/wallpaper/ILockScreenWallpaper;)V
    .locals 0
    ...
    .line 807
    iput-object p5, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mLockscreenWallpaper:Lcom/coloros/systemui/keyguard/wallpaper/ILockScreenWallpaper;
...
.method public updateMediaMetaData(ZZ)V
    ...
    .line 616
    iget-object v3, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mStatusBarStateController:Lcom/android/systemui/plugins/statusbar/StatusBarStateController;
    ...
    .line 617
    invoke-direct {p0, v2, p2, v0}, Lcom/android/systemui/statusbar/NotificationMediaManager;->finishUpdateMediaMetaData(ZZLandroid/graphics/Bitmap;)V
    ...
    .line 620
    invoke-virtual {v4, p0}, Lcom/android/systemui/statusbar/NotificationMediaManager$ProcessArtworkTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    .line 628
    :cond_8
    invoke-direct {p0, p1, p2, v4}, Lcom/android/systemui/statusbar/NotificationMediaManager;->finishUpdateMediaMetaData(ZZLandroid/graphics/Bitmap;)V
    ...
    .line 576
    iget-object p0, p0, Lcom/android/systemui/statusbar/NotificationMediaManager;->mStatusBarWindowController:Ldagger/Lazy;
    ...
    .line 578
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/phone/StatusBarWindowController;->setBackdropShowing(Z)V
