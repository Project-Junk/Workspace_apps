...
.field private mNotificationHeaderSidePadding:I
...
.method private getMinHeight(IZ)I
    ...
    invoke-virtual {v5}, Lcom/android/systemui/statusbar/notification/row/HybridNotificationView;->getHeight()I
...
.method private initDimens()V
    ...
    .line 146
    sget v1, Lcom/coloros/common/util/ResourceUtil;->android_dimen_notification_content_margin:I
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeaderSidePadding:I
...
.method private recreateLowPriorityHeader(Landroid/app/Notification$Builder;)V
    ...
    invoke-virtual {p1}, Landroid/view/NotificationHeaderView;->getPaddingLeft()I

    move-result v0

    iget v1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeaderSidePadding:I
    ...
    .line 374
    invoke-virtual {v2}, Landroid/view/NotificationHeaderView;->getPaddingRight()I

    move-result v2

    iget v3, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeaderSidePadding:I

    add-int/2addr v2, v3

    iget-object v3, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;

    invoke-virtual {v3}, Landroid/view/NotificationHeaderView;->getPaddingBottom()I

    move-result v3

    .line 373
    invoke-virtual {p1, v0, v1, v2, v3}, Landroid/view/NotificationHeaderView;->setPaddingRelative(IIII)V

    .line 377
    :cond_1
    iget-object p1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeaderLowPriority:Landroid/view/NotificationHeaderView;

    sget v0, Lcom/coloros/common/util/ResourceUtil;->android_id_expand_button:I
...
.method public addNotification(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;I)V
    ...
    iget-wide v0, p2, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->postTime:J
    ...
    iget-wide v0, v0, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->postTime:J

    iput-wide v0, p2, Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;->postTime:J
...
.method protected onMeasure(II)V
    ...
    .line 240
    :cond_c
    invoke-virtual {v0, v8, v14}, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->setMeasuredDimension(II)V
...
.method public recreateNotificationHeader(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v3}, Landroid/view/NotificationHeaderView;->getPaddingTop()I
    ...
    .line 333
    invoke-virtual {v4}, Landroid/view/NotificationHeaderView;->getPaddingRight()I

    move-result v4

    iget v5, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeaderSidePadding:I
    ...
    invoke-virtual {v5}, Landroid/view/NotificationHeaderView;->getPaddingBottom()I

    move-result v5

    .line 332
    invoke-virtual {v0, v1, v3, v4, v5}, Landroid/view/NotificationHeaderView;->setPaddingRelative(IIII)V
...
.method public startAnimationToState(Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;)V
    ...
    iget v12, v8, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->alpha:F
...
.method public updateState(Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;Lcom/android/systemui/statusbar/notification/stack/AmbientState;)V
    ...
    invoke-virtual {v12}, Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;->getGuts()Lcom/android/systemui/statusbar/notification/row/NotificationGuts;
    ...
    invoke-virtual {v12}, Lcom/android/systemui/statusbar/notification/row/NotificationGuts;->isExposed()Z
    ...
    .line 578
    iget v12, v1, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->zTranslation:F

    invoke-virtual {v0, v12}, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->setTranslationZ(F)V

    goto :goto_4

    .line 580
    :cond_4
    invoke-virtual {v0, v10}, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->setTranslationZ(F)V
    ...
    .line 609
    iput v10, v8, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->yTranslation:F

    const/4 v10, 0x0

    .line 610
    iput-boolean v10, v8, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->hidden:Z
    ...
    :goto_a
    iput v10, v8, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->zTranslation:F
    ...
    .line 622
    iput v10, v8, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->alpha:F
    ...
    iget v4, v8, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->yTranslation:F
    ...
    .line 627
    iget v4, v8, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->alpha:F
    ...
    iput v4, v8, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->alpha:F
