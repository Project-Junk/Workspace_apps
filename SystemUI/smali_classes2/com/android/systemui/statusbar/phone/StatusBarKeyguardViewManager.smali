...
.field private static final WAKE_AND_UNLOCK_SCRIM_FADEOUT_DURATION_MS:J = 0xc8L
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/keyguard/ViewMediatorCallback;Lcom/android/internal/widget/LockPatternUtils;)V
    ...
    .line 141
    new-instance v0, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBarKeyguardViewManager$Y6PZvneFKtW-FZxobcK6ZRGqJh0;

    invoke-direct {v0, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBarKeyguardViewManager$Y6PZvneFKtW-FZxobcK6ZRGqJh0;-><init>(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mBottomAreaExpansionListener:Lcom/android/systemui/statusbar/phone/NotificationPanelView$BottomAreaExpansionListener;
...
.method private isShowingLockIcon()Z
    .locals 4
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mNotificationPanelView:Lcom/android/systemui/statusbar/phone/NotificationPanelView;

    .line 1074
    invoke-virtual {v2}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->getCameraExpanded()Z
...
.method private updateLockIcon()V
    ...
    .line 306
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->isShowingLockIcon()Z
    ...
    const-string v1, "updateLockIcon, lockicon fade in"
    ...
    const-string v1, "updateLockIcon, lockicon fade out"
    ...
    invoke-static {p0, v3, v4, v2, v1}, Lcom/android/systemui/statusbar/CrossFadeHelper;->fadeOut(Landroid/view/View;JILjava/lang/Runnable;)V
...
.method public isBouncerShownSoon()Z
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/KeyguardBouncer;->isBouncerShownSoon()Z
...
.method public synthetic lambda$new$0$StatusBarKeyguardViewManager(Landroid/content/Context;Z)V
    .locals 3
    ...
    const-string v2, "onCameraExpansionChanged, isStartSwipe = "
...
.method public synthetic lambda$registerStatusBar$1$StatusBarKeyguardViewManager(FF)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/keyguard/KeyguardHostView;->onFling(FF)V

    :cond_0
    return-void
.end method

.method public synthetic lambda$wakeAndUnlockDejank$2$StatusBarKeyguardViewManager()V
    .locals 1
...
.method public onThemeChanged()V
    ...
    const-string v0, "onThemeChanged(), fbe mode, return."
...
.method public registerStatusBar(Lcom/android/systemui/statusbar/phone/StatusBar;Landroid/view/ViewGroup;Lcom/android/systemui/statusbar/phone/NotificationPanelView;Lcom/android/systemui/statusbar/phone/BiometricUnlockController;Lcom/android/systemui/keyguard/DismissCallbackRegistry;Landroid/view/ViewGroup;)V
    ...
    new-instance p2, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBarKeyguardViewManager$tiYSEBcPMZELUPP_hy4xDIGvK0E;

    invoke-direct {p2, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$StatusBarKeyguardViewManager$tiYSEBcPMZELUPP_hy4xDIGvK0E;-><init>(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)V

    invoke-virtual {p1, p2}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->setKeyguardFlingListener(Lcom/coloros/systemui/keyguard/security/KeyguardFlingDetector$OnKeyguardFlingListener;)V

    .line 252
    invoke-virtual {p3, p0}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->setExpansionListener(Lcom/android/systemui/statusbar/phone/NotificationPanelView$PanelExpansionListener;)V

    .line 255
    iget-object p0, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mBottomAreaExpansionListener:Lcom/android/systemui/statusbar/phone/NotificationPanelView$BottomAreaExpansionListener;

    invoke-virtual {p3, p0}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->setBottomAreaExpansionListener(Lcom/android/systemui/statusbar/phone/NotificationPanelView$BottomAreaExpansionListener;)V
...
.method public setOccluded(ZZ)V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/StatusBar;->noneAnimateKeyguardUnOccluding()V
...
.method public showBouncer(Z)V
    ...
    const-string v1, "Bouncer is showing"
...
.method public startPreHideAnimation(Ljava/lang/Runnable;)V
    ...
    const-string v0, "startPreHideAnimation, pre hide lockicon"
...
.method public updateKeyguardStatusViewVisibility()V
    ...
    .line 1091
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->updateKeyguardStatusViewVisibility()V
...
.method protected updateStates()V
    ...
    invoke-virtual {v3}, Lcom/android/systemui/statusbar/phone/KeyguardBouncer;->isFullscreenBouncer()Z
    ...
    iget-boolean v7, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mFirstUpdate:Z
    ...
    .line 831
    iget-boolean v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mFirstUpdate:Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/systemui/statusbar/phone/StatusBarWindowController;->setBouncerShowing(Z)V

    .line 837
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {v0, v2}, Lcom/android/systemui/statusbar/phone/StatusBar;->setBouncerShowing(Z)V
    ...
    .line 853
    :goto_8
    invoke-virtual {v7, v4}, Lcom/android/keyguard/KeyguardUpdateMonitor;->onKeyguardVisibilityChanged(Z)V
    ...
    iget-boolean v4, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mFirstUpdate:Z
    ...
    .line 866
    :cond_13
    iput-boolean v6, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mFirstUpdate:Z
    ...
    .line 870
    iput-boolean v3, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mLastBouncerDismissible:Z

    .line 871
    iput-boolean v5, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mLastRemoteInputActive:Z
