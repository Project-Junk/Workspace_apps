...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/policy/KeyguardMonitor;Landroid/os/Handler;Lcom/android/systemui/plugins/ActivityStarter;)V
    ...
    invoke-interface {p2, p1}, Lcom/android/systemui/statusbar/policy/KeyguardMonitor;->addCallback(Ljava/lang/Object;)V
...
.method private refreshUsers(I)V
    ...
    .line 307
    invoke-virtual {v2, p0}, Lcom/android/systemui/statusbar/policy/UserSwitcherController$1;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public removeUserId(I)V
    ...
    const-string v1, "switch_to_user"

    const-string v2, "1"

    invoke-static {v0, v1, v2}, Lcom/coloros/systemui/qs/helper/QsStatisticUtil;->collectShortcutsCenterEvent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public showAddUserDialog()V
    ...
    const-class v1, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;
    ...
    check-cast v0, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;

    iget-object v1, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mContext:Landroid/content/Context;

    invoke-virtual {v0, p0, v1}, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;->addUserDialog(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Landroid/content/Context;)Lcolor/support/v7/app/AlertDialog;
...
.method protected showExitGuestDialog(II)V
    ...
    invoke-virtual {v0, p0, v1, p1, p2}, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;->exitGuestDialog(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Landroid/content/Context;II)Lcolor/support/v7/app/AlertDialog;
...
.method public switchTo(I)V
    ...
    .line 445
    iget-object v3, v2, Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;->info:Landroid/content/pm/UserInfo;
    ...
    .line 446
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->switchTo(Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;)V
    ...
    const-string v0, "Couldn\'t switch to user, id="
...
.method public switchTo(Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;)V
    ...
    check-cast p1, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;
    ...
    .line 385
    invoke-virtual {p1, p0, v0}, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;->createNewGuestUser(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 391
    invoke-virtual {v0, v2, v1}, Landroid/os/UserManager;->createGuest(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/UserInfo;
    ...
    const-class v2, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;
    ...
    check-cast v1, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;
    ...
    invoke-virtual {v1, p0, v0, p1}, Lcom/coloros/systemui/qs/helper/UserSwitcherControllerHelper;->showSwitchDialog(Landroid/content/Context;ILjava/lang/String;)V
    ...
    :goto_1
    const-string v0, "switch_to_user"

    invoke-static {p0, v0, p1}, Lcom/coloros/systemui/qs/helper/QsStatisticUtil;->collectShortcutsCenterEvent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
