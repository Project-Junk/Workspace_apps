...
.method private upgradeTuner(IILandroid/os/Handler;)V
    ...
    const-string p3, "icon_blacklist"

    .line 117
    invoke-virtual {p0, p3}, Lcom/android/systemui/tuner/TunerServiceImpl;->getValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 125
    invoke-static {v1, p3, v0, v2}, Landroid/provider/Settings$Secure;->putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    .line 131
    iget-object p3, p0, Lcom/android/systemui/tuner/TunerServiceImpl;->mContext:Landroid/content/Context;

    const/4 v0, 0x0

    invoke-static {p3, v0}, Lcom/android/systemui/tuner/TunerServiceImpl;->setTunerEnabled(Landroid/content/Context;Z)V
    ...
    new-instance p3, Lcom/android/systemui/tuner/-$$Lambda$TunerServiceImpl$6-LaNwUHcRc1UGw8s8y1YCsTRbQ;

    invoke-direct {p3, p0}, Lcom/android/systemui/tuner/-$$Lambda$TunerServiceImpl$6-LaNwUHcRc1UGw8s8y1YCsTRbQ;-><init>(Lcom/android/systemui/tuner/TunerServiceImpl;)V
...
.method public synthetic lambda$upgradeTuner$0$TunerServiceImpl()V
    .locals 0
