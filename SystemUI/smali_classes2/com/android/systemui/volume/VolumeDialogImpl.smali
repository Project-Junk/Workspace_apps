...
.field static final DIALOG_SHOW_ANIMATION_DURATION:I = 0x12c
...
.method static synthetic access$4200(Lcom/android/systemui/volume/VolumeDialogImpl;)Landroid/content/Context;
    .locals 0
...
.method private initDialog()V
    ...
    sget v3, Lcom/coloros/common/util/ResourceUtil;->android_drawable_ic_phone:I
...
.method private initRow(Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;IIIZZ)V
    ...
    invoke-virtual {p4, p6}, Landroid/widget/TextView;->setId(I)V
    ...
    invoke-virtual {p6, v0}, Landroid/widget/TextView;->setFilters([Landroid/text/InputFilter;)V
    ...
    invoke-static {p1, p6}, Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;->access$902(Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;Landroid/widget/FrameLayout;)Landroid/widget/FrameLayout;
    ...
    check-cast p6, Landroid/widget/SeekBar;

    invoke-static {p1, p6}, Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;->access$1002(Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;Landroid/widget/SeekBar;)Landroid/widget/SeekBar;
    ...
    invoke-direct {v0, p0, p1, p5}, Lcom/android/systemui/volume/VolumeDialogImpl$VolumeSeekBarChangeListener;-><init>(Lcom/android/systemui/volume/VolumeDialogImpl;Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;Lcom/android/systemui/volume/VolumeDialogImpl$1;)V

    invoke-virtual {p6, v0}, Landroid/widget/SeekBar;->setOnSeekBarChangeListener(Landroid/widget/SeekBar$OnSeekBarChangeListener;)V

    .line 427
    invoke-static {p1, p5}, Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;->access$1202(Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;Landroid/animation/ObjectAnimator;)Landroid/animation/ObjectAnimator;
...
.method private maybeShowToastH(I)V
    ...
    sget v3, Lcom/coloros/common/util/ResourceUtil;->android_string_volume_dialog_ringer_guidance_vibrate:I
    ...
    sget v3, Lcom/coloros/common/util/ResourceUtil;->android_string_volume_dialog_ringer_guidance_silent:I
...
.method private updateVolumeRowH(Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;)V
    ...
    :cond_1e
    iget-boolean v13, v0, Lcom/android/systemui/volume/VolumeDialogImpl;->mAutomute:Z
    ...
    invoke-virtual {v15, v13}, Landroid/widget/ImageButton;->setImageResource(I)V
    ...
    iget-object v10, v0, Lcom/android/systemui/volume/VolumeDialogImpl;->mContext:Landroid/content/Context;

    iget-boolean v11, v0, Lcom/android/systemui/volume/VolumeDialogImpl;->mShowA11yStream:Z
...
.method composeWindowTitle()Ljava/lang/CharSequence;
    ...
    invoke-static {v2}, Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;->access$1400(Lcom/android/systemui/volume/VolumeDialogImpl$VolumeRow;)Lcom/android/systemui/plugins/VolumeDialogController$StreamState;
...
.method public synthetic lambda$dismissH$12$VolumeDialogImpl()V
    ...
    new-instance v1, Lcom/android/systemui/volume/-$$Lambda$VolumeDialogImpl$tPGS84TC6wiBcqby9v78s79azkM;

    invoke-direct {v1, p0}, Lcom/android/systemui/volume/-$$Lambda$VolumeDialogImpl$tPGS84TC6wiBcqby9v78s79azkM;-><init>(Lcom/android/systemui/volume/VolumeDialogImpl;)V
...
.method public synthetic lambda$initDialog$1$VolumeDialogImpl(Landroid/content/DialogInterface;)V
    ...
    new-instance v0, Lcom/android/systemui/volume/-$$Lambda$VolumeDialogImpl$iaAXYh2dQzxcwGBX1LLlOVnwzls;

    invoke-direct {v0, p0}, Lcom/android/systemui/volume/-$$Lambda$VolumeDialogImpl$iaAXYh2dQzxcwGBX1LLlOVnwzls;-><init>(Lcom/android/systemui/volume/VolumeDialogImpl;)V
...
.method public synthetic lambda$null$0$VolumeDialogImpl()V
    .locals 3
...
.method public synthetic lambda$null$11$VolumeDialogImpl()V
    .locals 1
