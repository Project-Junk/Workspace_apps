...
.method constructor <init>(Landroid/widget/ExpandableListAdapter;Lcom/color/support/widget/ColorExpandableListView;)V
    ...
    iget-object p0, p0, Lcom/color/support/widget/ColorExpandableListView$InnerExpandableListAdapter;->mDataSetObserver:Landroid/database/DataSetObserver;

    invoke-interface {p1, p0}, Landroid/widget/ExpandableListAdapter;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method private addCache(Landroid/view/View;II)V
    ...
    .line 387
    iget-object p0, p0, Lcom/color/support/widget/ColorExpandableListView$InnerExpandableListAdapter;->showChildView:Landroid/util/SparseArray;
...
.method private collapseAnimationStart(Lcom/color/support/widget/ColorExpandableListView$DummyView;IZI)V
    ...
    invoke-virtual {p1, p0}, Lcom/color/support/widget/ColorExpandableListView$DummyView;->setTag(Ljava/lang/Object;)V
...
.method private getAnimationView(IZLandroid/view/View;)Landroid/view/View;
    ...
    const-string p1, "ColorExpandableListView"
...
.method private getCacheView(II)Landroid/view/View;
    ...
    .line 394
    iget-object p0, p0, Lcom/color/support/widget/ColorExpandableListView$InnerExpandableListAdapter;->cacheChildView:Landroid/util/SparseArray;
...
.method private getGroupInfo(I)Lcom/color/support/widget/ColorExpandableListView$GroupInfo;
    ...
    .line 238
    iget-object p0, p0, Lcom/color/support/widget/ColorExpandableListView$InnerExpandableListAdapter;->groupInfo:Landroid/util/SparseArray;
...
.method private getRealChildType(II)I
    ...
    .line 310
    iget-object p0, p0, Lcom/color/support/widget/ColorExpandableListView$InnerExpandableListAdapter;->listAdapter:Landroid/widget/ExpandableListAdapter;
...
.method private isGroupExpanded(I)Z
    ...
    invoke-virtual {p0, p1}, Lcom/color/support/widget/ColorExpandableListView;->isGroupExpanded(I)Z

    move-result p0

    if-eqz p0, :cond_1

    iget-boolean p0, v0, Lcom/color/support/widget/ColorExpandableListView$GroupInfo;->animating:Z

    if-eqz p0, :cond_0

    iget-boolean p0, v0, Lcom/color/support/widget/ColorExpandableListView$GroupInfo;->expanding:Z
...
.method private startCollapseAnimation(I)Z
    ...
    .line 271
    iget-boolean p1, p0, Lcom/color/support/widget/ColorExpandableListView$GroupInfo;->animating:Z

    const/4 v0, 0x0

    if-eqz p1, :cond_0

    iget-boolean p1, p0, Lcom/color/support/widget/ColorExpandableListView$GroupInfo;->expanding:Z
    ...
    .line 274
    iput-boolean p1, p0, Lcom/color/support/widget/ColorExpandableListView$GroupInfo;->animating:Z
...
.method private startExpandAnimation(I)Z
    ...
    .line 265
    iput-boolean p1, p0, Lcom/color/support/widget/ColorExpandableListView$GroupInfo;->expanding:Z
