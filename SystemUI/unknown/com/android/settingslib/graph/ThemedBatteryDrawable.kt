...
import com.android.settingslib.internal.resource.InternalResourceLoad
...
open class ThemedBatteryDrawable(private val context: Context, frameColor: Int) : Drawable() {
    ...
    open var criticalLevel: Int = context.resources.getInteger(
            InternalResourceLoad.getIntegerId(context, "config_criticalBatteryWarningLevel"));
    ...
    private fun loadPaths() {
        val pathString = context.resources.getString(
                InternalResourceLoad.getStringId(context, "config_batterymeterPerimeterPath"))
        perimeterPath.set(PathParser.createPathFromPathData(pathString))
        perimeterPath.computeBounds(RectF(), true)

        val errorPathString = context.resources.getString(
                InternalResourceLoad.getStringId(context, "config_batterymeterErrorPerimeterPath"));
        errorPerimeterPath.set(PathParser.createPathFromPathData(errorPathString))
        errorPerimeterPath.computeBounds(RectF(), true)

        val fillMaskString = context.resources.getString(
                InternalResourceLoad.getIntegerId(context, "config_batterymeterFillMask"))
        fillMask.set(PathParser.createPathFromPathData(fillMaskString))
        // Set the fill rect so we can calculate the fill properly
        fillMask.computeBounds(fillRect, true)

        val boltPathString = context.resources.getString(
                InternalResourceLoad.getStringId(context, "config_batterymeterBoltPath"));
        boltPath.set(PathParser.createPathFromPathData(boltPathString))

        val plusPathString = context.resources.getString(
                InternalResourceLoad.getIntegerId(context, "config_batterymeterPowersavePath"))
        plusPath.set(PathParser.createPathFromPathData(plusPathString))

        dualTone = context.resources.getBoolean(
                InternalResourceLoad.getBoolId(context, "config_batterymeterDualTone"));
    }
