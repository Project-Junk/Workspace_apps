...
oneway interface IOverviewProxy {
    ...
    /**
    * Ask QuickStep to prepare the next app's icon
    */
    void getPreAppIcon() = 17;

    /**
    * Switch to next app by full-screen side gesture
    */
    void switchPreApp(int side) = 18;

    /**
    * Switch to next app directly by curved-screen side gesutre(such as Find X)
    */
    void switchPreAppCurvedGesture() = 19;
    //#endif /* COLOROS_EDIT */
}
