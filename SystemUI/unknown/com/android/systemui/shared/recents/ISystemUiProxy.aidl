...
interface ISystemUiProxy {
    ...
    */
    ...
    //#ifdef COLOROS_EDIT
    //Xiao.Cai@Rom.SysApp, 2019/7/25, Add for side gesture
    /**
    * return the previous app's icon to SystemUI for full-screen side gesture
    * 18 was used by onAssistantGestureCompletion in Launcher's aidl file
    */
    void onGetAppIcon(in Bitmap icon) = 20;
    //#endif /* COLOROS_EDIT */

    //#ifdef COLOROS_EDIT
    //Zhengrong.Tang@Rom.SysApp, 2019/7/25, Add for nav gesture
    //Xiao.Cai@SysApp.RecentTask modified on 2019/9/26 : add for landscape gesture
    /**
    * notify systemui inject motion event
    */
    void notifyInjectAllEvent(in MotionEvent down, in MotionEvent up, in List<MotionEvent> events) = 21;
    void notifyInjectEvent(in MotionEvent down, in MotionEvent up) = 22;
    void notifyKeyEvent(in int key) = 23;
    //#endif /* COLOROS_EDIT */
}
