...
.method public static final mapNotNull(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/List;
    ...
    .line 238
    .local v9, "$i$a$-forEach-MapsKt___MapsKt$mapNotNullTo$1":I
    ...
    .local v11, "$i$a$-let-MapsKt___MapsKt$mapNotNullTo$1$1":I
    invoke-interface {v1, v10}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .end local v10    # "it$iv":Ljava/lang/Object;
    .end local v11    # "$i$a$-let-MapsKt___MapsKt$mapNotNullTo$1$1":I
    goto :goto_0

    .line 240
    .end local v7    # "element$iv$iv":Ljava/util/Map$Entry;
    .end local v8    # "element$iv":Ljava/util/Map$Entry;
    .end local v9    # "$i$a$-forEach-MapsKt___MapsKt$mapNotNullTo$1":I
    :cond_1
    nop
...
.method private static final maxBy(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map$Entry;
    ...
    .line 256
    .restart local v1    # "$this$maxBy$iv":Ljava/lang/Iterable;
    ...
    .restart local v5    # "maxValue$iv":Ljava/lang/Comparable;
    .restart local v6    # "e$iv":Ljava/lang/Object;
    .restart local v7    # "v$iv":Ljava/lang/Comparable;
    :cond_3
    goto :goto_0
.end method
...
.method public static final minBy(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map$Entry;
    ...
    .line 270
    .restart local v1    # "$this$minBy$iv":Ljava/lang/Iterable;
    .restart local v2    # "$i$f$minBy":I
    .restart local v3    # "iterator$iv":Ljava/util/Iterator;
    .restart local v4    # "minElem$iv":Ljava/lang/Object;
    .restart local v5    # "minValue$iv":Ljava/lang/Comparable;
    .restart local v6    # "e$iv":Ljava/lang/Object;
    .restart local v7    # "v$iv":Ljava/lang/Comparable;
    :cond_3
    goto :goto_0
